...
{
	m_pNORMAL_TAB_BUTTON = CreateTextButton ( "FRIEND_NORMAL_TAB_BUTTON", FRIEND_NORMAL_TAB_BUTTON, (char*)ID2GAMEWORD("FRIEND_TAB_BUTTON",0) );
	m_pBLOCK_TAB_BUTTON	 = CreateTextButton ( "FRIEND_BLOCK_TAB_BUTTON", FRIEND_BLOCK_TAB_BUTTON, (char*)ID2GAMEWORD("FRIEND_TAB_BUTTON",1) );
	m_pRECEIVE_TAB_BUTTON = CreateTextButton ( "FRIEND_RECEIVE_TAB_BUTTON", RECEIVE_TAB_BUTTON, (char*)ID2GAMEWORD("FRIEND_TAB_BUTTON",2) );
	m_pRECEIVE_TAB_BUTTON->SetVisibleSingle( FALSE );
	m_pSEND_TAB_BUTTON	= CreateTextButton ( "FRIEND_SEND_TAB_BUTTON", SEND_TAB_BUTTON, (char*)ID2GAMEWORD("FRIEND_TAB_BUTTON",3) );
	m_pSEND_TAB_BUTTON->SetVisibleSingle( FALSE );

	{
		m_bg_white = new CUIControl;
		m_bg_white->CreateSub ( this, "FRIEND_WINDOW_BG_WHITE", UI_FLAG_DEFAULT);	
