...
void CSecPassCheckPage::CreateSubControl ()
{
	...
	pOKButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, CHECKSECPASS_OK );
	...
	pQuitButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, CHECKSECPASS_CANCEL );
	...
	pReInputButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, CHECKSECPASS_REINPUT );
