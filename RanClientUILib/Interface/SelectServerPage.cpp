...
void CSelectServerPage::CreateSubControl ()
{
	...
	if ( COuterInterface::GetInstance().IsCHANNEL() ) // 채널
	{
		...
		pButton->CreateSub( this, "BASIC_TEXT_BUTTON18", UI_FLAG_XSIZE, SELECT_CHINA_AREA_BACK );
		...
		m_pSelectServerChannel->CreateBaseWindowBlackRed ( "SELECT_SERVER_PAGE", (char*) ID2GAMEWORD ( "SELECT_SERVER" ) );			
	...
	else
	{
		...
		pOKButton->CreateBaseButton ( "SELECT_SERVER_CONNECT", CBasicTextButton::SIZE18, CBasicButton::CLICK_FLIP, (char*)ID2GAMEWORD ( "SELECT_SERVER_CONNECTQUIT", 0 ) );
	...
	pQuitButton->CreateSub ( this, "BASIC_TEXT_BUTTON18", UI_FLAG_XSIZE, SELECT_SERVER_QUIT );
