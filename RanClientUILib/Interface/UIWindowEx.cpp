...
void CUIWindowEx::CreateBaseWindowBlackNew ( char* szWindowKeyword, char* szWindowName )
{
	...
	CreateCloseButton ( "BASIC_WINDOW_BLACK_CLOSE", "BASIC_WINDOW_BLACK_CLOSE_F", "BASIC_WINDOW_BLACK_CLOSE_OVER" );
	CreateBody ( "BASIC_WINDOW_BLACK_BODY", "BASIC_WINDOW_BLACK_BODY_LEFT", "BASIC_WINDOW_BLACK_BODY_UP", "BASIC_WINDOW_BODY_MAIN_BLACKNEW", "BASIC_WINDOW_BLACK_BODY_DOWN", "BASIC_WINDOW_BLACK_BODY_RIGHT" );
	ResizeControl ( szWindowKeyword );
