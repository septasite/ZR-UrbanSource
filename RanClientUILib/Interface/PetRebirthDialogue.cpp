...
void CPetRebirthDialogue::CreateSubControl ()
{
	...
	pButton->CreateBaseButton ( "PET_OK_BUTTON", CBasicTextButton::SIZE23_NEW, CBasicButton::CLICK_FLIP, ID2GAMEWORD("LOGIN_PAGE_OKCANCEL",0) );
	RegisterControl ( pButton );
	
	pButton = new CBasicTextButton;
	pButton->CreateSub ( this, "BASIC_TEXT_BUTTON16", UI_FLAG_XSIZE, CANCLE_BUTTON );
	pButton->CreateBaseButton ( "PET_CANCLE_BUTTON", CBasicTextButton::SIZE23_NEW, CBasicButton::CLICK_FLIP, ID2GAMEWORD("LOGIN_PAGE_OKCANCEL",1) );
	RegisterControl ( pButton );
}
