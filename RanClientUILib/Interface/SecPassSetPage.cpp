...
void CSecPassSetPage::CreateSubControl ()
{
	...
	pOKButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, SETSECPASS_OK );
	...
	pQuitButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, SETSECPASS_CANCEL );
