...
void CAttendanceBookWindow::CreateSubControl ()
{
	...
	CD3DFontPar * pFont18 = DxFontMan::GetInstance().LoadDxFont( _DEFAULT_FONT, 24, FALSE );
	CD3DFontPar * pFont12 = DxFontMan::GetInstance().LoadDxFont( _DEFAULT_FONT, 18, FALSE );
