...
void CSelectChinaAreaPage::CreateSubControl ()
{
	...
	pTextButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, SELECT_AREA_BUTTON_00 );
	pTextButton->CreateBaseButton ( "SELECT_AREA_BUTTON_01", CBasicTextButton::SIZE24, CBasicButton::CLICK_FLIP, RANPARAM::China_Region[0].strName.GetString() );
	pTextButton->SetFlip ( TRUE );
	RegisterControl ( pTextButton );

	pTextButton = new CBasicTextButton;
	pTextButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, SELECT_AREA_BUTTON_01 );
	pTextButton->CreateBaseButton ( "SELECT_AREA_BUTTON_02", CBasicTextButton::SIZE24, CBasicButton::CLICK_FLIP, RANPARAM::China_Region[1].strName.GetString() );
	pTextButton->SetFlip ( TRUE );
	RegisterControl ( pTextButton );

	pTextButton = new CBasicTextButton;
	pTextButton->CreateSub ( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, SELECT_AREA_BUTTON_02 );
	pTextButton->CreateBaseButton ( "SELECT_AREA_BUTTON_03", CBasicTextButton::SIZE24, CBasicButton::CLICK_FLIP, RANPARAM::China_Region[2].strName.GetString() );
	pTextButton->SetFlip ( TRUE );
	RegisterControl ( pTextButton );
/*
	pTextButton = new CBasicTextButton;
 ...
 */
	pTextButton = new CBasicTextButton;
	pTextButton->CreateSub( this, "BASIC_TEXT_BUTTON24", UI_FLAG_XSIZE, SELECT_AREA_QUIT );
	pTextButton->CreateBaseButton( "SELECT_AREA_QUIT", CBasicTextButton::SIZE24, CBasicButton::CLICK_FLIP, (char*)ID2GAMEWORD( "SELECT_SERVER_CONNECTQUIT", 1 ) );
