...
const	int	CHAT_REGION		= 0x0040;	//add region chat by AnFire16 ( 7/31/2017)
const	int	CHAT_SYSTEM		= 0x0100;	//	시스템
const	int	CHAT_ALL		= CHAT_TOALL|CHAT_SYSTEM|CHAT_NORMAL|CHAT_PRIVATE|CHAT_PARTY|CHAT_GUILD|CHAT_ALLIANCE|CHAT_REGION;
...
class CBasicChatRightBody : public CUIGroup
{
	...
	static	const CString REGION_SYMBOL; //add region chat by AnFire16 ( 7/31/2017)
...
public:
	enum
	{
		...
		CHAT_TEXTBOX_PARTY,
		CHAT_TEXTBOX_CLUB,
		CHAT_TEXTBOX_REGION, //add region chat by AnFire16 ( 7/31/2017)
...
private:	//	전체
	...
	CBasicTextBoxEx*	m_pTextBox_REGION;
	CBasicScrollBarEx*	m_pScrollBar_REGION;
	...
	//CBasicTextButton*	m_pChatRegionButton;
...
public:
	...
	void	BEGIN_REGION_CHAT ( const CString& strMessage = "" ); //add region chat by AnFire16 ( 7/31/2017)
...
private:
	...
	bool	SEND_REGION_MESSAGE ( const CString& strOrigin ); //add region chat by AnFire16 ( 7/31/2017)
