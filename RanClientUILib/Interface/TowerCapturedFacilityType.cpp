...
CTowerCapturedFacilityType::CTowerCapturedFacilityType () :
    m_bPLAY ( false )
{
}
...
void CTowerCapturedFacilityType::CreateSubControl ( CString strKeyword )
{
...
void	CTowerCapturedFacilityType::START()
{
	RESET ();
	m_bPLAY = true;
}

void	CTowerCapturedFacilityType::RESET()
{
	m_bPLAY = false;
	m_fPlayedTime = 0.0f;
	m_pXControl->SetVisibleSingle ( FALSE );
...
void CTowerCapturedFacilityType::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
