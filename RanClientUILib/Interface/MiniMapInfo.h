...
protected:
	enum
	{
		...
		MINIMAP_SCHOOL_MARK_0,
		MINIMAP_SCHOOL_MARK_1,
		MINIMAP_SCHOOL_MARK_2,
		MINIMAP_SCHOOL_MARK_NONE,
	};


	enum
	{
		MINIMAP_CTF_SCHOOL = 4,
	};
...
private:
	...
	CBasicTextBox*	m_pMinimapNameTextBox;
	CBasicTextBox*	m_pServerTimeText;
	CUIControl*		m_pClubMark;

	CUIControl*		m_pCTFSCHOOLDUMMY;
	CUIControl*		m_pCTFSCHOOL[MINIMAP_CTF_SCHOOL];
};