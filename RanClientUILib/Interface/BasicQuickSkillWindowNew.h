...
const DWORD UIMSG_BASIC_LBDUP_WINDOW_NEW = UIMSG_USER1;
...
class CBasicQuickSkillWindowNew : public CUIGroup
{
public:
	enum
	{
...
public:
	CBasicQuickSkillWindowNew(void);
	virtual ~CBasicQuickSkillWindowNew(void);
