...
CProgressTypeCtf::CProgressTypeCtf () :
    m_bPLAY ( false )
{
}
...
void CProgressTypeCtf::CreateSubControl ( CString strKeyword )
{
...
void	CProgressTypeCtf::START()
{
	RESET ();
	m_bPLAY = true;
}

void	CProgressTypeCtf::RESET()
{
	m_fPlayedTime = 0.0f;
...
void CProgressTypeCtf::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
