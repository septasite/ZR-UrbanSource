...
class	CTowerCapturedFacilityType;
class	CTowerCapturedDisplayFacility : public CUIGroup
{
public:
	enum
	{
		TOWER_CAPTURED_FACILITY_TOWER_SG = NO_ID + 1,
...
public:
	CTowerCapturedDisplayFacility ();
	virtual	~CTowerCapturedDisplayFacility ();
...
private:
	CTowerCapturedFacilityType*	m_pQI_TYPE[MAXTYPE];
