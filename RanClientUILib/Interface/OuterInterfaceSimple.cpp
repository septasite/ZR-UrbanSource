...
void COuterInterface::ToSelectServerPage ( UIGUID cID )
{
	...
	pTextBoxPage->SetText ( ID2GAMEEXTEXT("2012_NEW_CHAR_TEXT_PAGE" , 0 ), NS_UITEXTCOLOR::DEFAULT );
...
//	HideGroup ( SELECT_CHARACTER_LEFTPAGE, bMakeMsg );
...
{
	pTextBoxPage->ClearText();
	pTextBoxPage->SetText ( ID2GAMEEXTEXT("2012_NEW_CHAR_TEXT_PAGE" , 1 ), NS_UITEXTCOLOR::DEFAULT );
...
{
	pTextBoxPage->ClearText();
	pTextBoxPage->SetText ( ID2GAMEEXTEXT("2012_NEW_CHAR_TEXT_PAGE" , 2 ), NS_UITEXTCOLOR::DEFAULT );
...
{
	pTextBoxPage->ClearText();
	pTextBoxPage->SetText ( ID2GAMEEXTEXT("2012_NEW_CHAR_TEXT_PAGE" , 3 ), NS_UITEXTCOLOR::DEFAULT );
