...
void CPKItemType::CreateSubControl ( CString strKeyword )
{
...
void	CPKItemType::START()
{
	RESET ();
	m_bPLAY = true;
}

void	CPKItemType::RESET()
{
	m_fPlayedTime = 0.0f;
...
void CPKItemType::Update ( int x, int y, BYTE LB, BYTE MB, BYTE RB, int nScroll, float fElapsedTime, BOOL bFirstControl )
{
