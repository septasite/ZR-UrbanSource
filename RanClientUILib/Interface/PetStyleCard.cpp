...
TCHAR * szPETSTYLECARD_NAME_E = _T("PETSTYLECARD_NAME_D");
TCHAR * szPETSTYLECARD_NAME_F = _T("PETSTYLECARD_NAME_D");
TCHAR * szPETSTYLECARD_NAME_G = _T("PETSTYLECARD_NAME_D");
TCHAR * szPETSTYLECARD_NAME_H = _T("PETSTYLECARD_NAME_D");
TCHAR * szPETSTYLECARD_NAME_I = _T("PETSTYLECARD_NAME_D");
TCHAR * szPETSTYLECARD_NAME_J = _T("PETSTYLECARD_NAME_D");
...
{
	CD3DFontPar * pFont = DxFontMan::GetInstance().LoadDxFont( _DEFAULT_FONT, 9, FALSE );
