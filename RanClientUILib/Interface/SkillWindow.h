...
protected:
	enum
	{
		...
		SKILL_WINDOW_PAGE2,
		SKILL_WINDOW_PAGE3,
		SKILL_WINDOW_HELP_BUTTON,
		RNSKILL_WINDOW_RESET_BUTTON,
		RNSKILL_WINDOW_ADJUST_BUTTON,
	};
...
private:
	...
	CBasicTextButton*	CreateButton ( char* szButton, UIGUID ControlID, char* szText );
