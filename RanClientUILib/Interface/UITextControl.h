...
namespace	NS_UITEXTCOLOR
{
	...
	const DWORD	LIGHTSKYBLUE	= D3DCOLOR_ARGB(0xFF,0x94,0xBD,0xE4);
	...
	const DWORD VIOLET			= D3DCOLOR_ARGB(0xFF,0xAE,0x00,0xFF);
	...
	// add for +17 UiItemInfo
	const DWORD LIGHTORANGE		= D3DCOLOR_ARGB(0xFF,0xFF,0x99,0x00);
	const DWORD AQUABLUE		= D3DCOLOR_ARGB(0xFF,0x0A,0xEA,0xEA); // New ÊÕ¿éÒÊÇèÒ§
	const DWORD IDNAMECOLOR		= D3DCOLOR_ARGB(0xFF,0x00,0xA8,0xFF); // New ÊÕ¿éÒÊÇèÒ§
	const DWORD PURPLEXD		= D3DCOLOR_ARGB(0xFF,0x94,0x29,0xFF);
	
	// clubBattle »ç¿ëÇÒ·Á°í Ãß°¡ ( »ö»ó°ª Á¶±Ý¾¿ Æ²¸² ) 
	const DWORD BLUE			= D3DCOLOR_ARGB(0xFF,0x00,0x26,0xFF);
	...
	const DWORD GRAY			= D3DCOLOR_ARGB(0xFF,0x96,0x96,0x96);
	const DWORD BLUEGREEN		= D3DCOLOR_ARGB(0xFF,0x76,0xEC,0xC6);
	const DWORD BRIGHTGREEN		= D3DCOLOR_ARGB(0xFF,0x00,0xFF,0x00);
	const DWORD DARKLBUE		= D3DCOLOR_ARGB(0xFF,0x87,0xCE,0xFF);

	//	»ç¿ëÃ³
	const DWORD ENABLE			= WHITE;	
