...
private:
	enum
	{
		...
		CLUB_PARTY_BUTTON,					//added by : tobets | 08-03-2012 | add party button in club window
...
private:
	...
	CBasicTextButton*	m_pPartyButton;		//added by : tobets | 08-03-2012 | add party button in club window
