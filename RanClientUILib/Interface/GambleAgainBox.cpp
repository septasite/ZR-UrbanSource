...
void CGambleAgainBox::CreateSubControl ()
{
	...
	pButton->CreateBaseButton ( "GAMBLE_AGAIN_OK_BUTTON", CBasicTextButton::SIZE23_NEW, CBasicButton::CLICK_FLIP, ID2GAMEWORD("GAMBLE_OKCANCEL",0) );
	RegisterControl ( pButton );
	
	pButton = new CBasicTextButton;
	pButton->CreateSub ( this, "BASIC_TEXT_BUTTON16", UI_FLAG_XSIZE, GAMBLE_AGAIN_CANCLE_BUTTON );
	pButton->CreateBaseButton ( "GAMBLE_AGAIN_CANCLE_BUTTON", CBasicTextButton::SIZE23_NEW, CBasicButton::CLICK_FLIP, ID2GAMEWORD("GAMBLE_OKCANCEL",1) );
	RegisterControl ( pButton );
