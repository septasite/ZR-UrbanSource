...
void CFriendWindowBlockPage::CreateSubControl ()
{
	...
	m_pADD_BLOCK = CreateButtonBlue ( "FRIEND_LIST_ADD_BLOCK_BUTTON", "FRIEND_LIST_BUTTON_TEXT_POS", pFont9, nAlignCenterBoth, FRIEND_LIST_ADD_BLOCK_BUTTON, "Block" );
	m_pADD_BLOCK->SetShortcutKey ( DIK_RETURN );
	m_pDEL_BLOCK = CreateButtonBlue ( "FRIEND_LIST_DEL_BLOCK_BUTTON", "FRIEND_LIST_BUTTON_TEXT_POS", pFont9, nAlignCenterBoth, FRIEND_LIST_DEL_BLOCK_BUTTON, "Remove" );
...
CBasicTextButton* CFriendWindowBlockPage::CreateTextButton24 ( const char* szButton, UIGUID ControlID, const char* szText )
{
...
CBasicButtonText* CFriendWindowBlockPage::CreateButtonBlue ( char* szButton, char* szTextBox, CD3DFontPar* pFont, int nAlign, UIGUID ControlID, CString strText )
{
