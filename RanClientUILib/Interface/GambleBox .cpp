...
void CGambleBox::CreateSubControl ()
{
	...
	pButton->CreateBaseButton ( "GAMBLE_OK_BUTTON", CBasicTextButton::SIZE23_NEW, CBasicButton::CLICK_FLIP, ID2GAMEWORD("GAMBLE_OKCANCEL",0) );
	RegisterControl ( pButton );
	
	pButton = new CBasicTextButton;
	pButton->CreateSub ( this, "BASIC_TEXT_BUTTON16", UI_FLAG_XSIZE, GAMBLE_CANCLE_BUTTON );
	pButton->CreateBaseButton ( "GAMBLE_CANCLE_BUTTON", CBasicTextButton::SIZE23_NEW, CBasicButton::CLICK_FLIP, ID2GAMEWORD("GAMBLE_OKCANCEL",1) );
	RegisterControl ( pButton );

	pButton = new CBasicTextButton;
	pButton->CreateSub ( this, "BASIC_TEXT_BUTTON16", UI_FLAG_XSIZE, GAMBLE_REINPUT_BUTTON );
	pButton->CreateBaseButton ( "GAMBLE_REINPUT_BUTTON", CBasicTextButton::SIZE23_NEW, CBasicButton::CLICK_FLIP, ID2GAMEWORD("GAMBLE_OKCANCEL",2) );
	RegisterControl ( pButton );
