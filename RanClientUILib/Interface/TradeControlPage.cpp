...
{	
	...
	if ( lnMoney >= 0 && lnMoney <= 999999){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, GLCONST_CHAR::dwITEM_MONEY_COLOR0 );}
	if ( lnMoney >= 1000000 && lnMoney <= 999999){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, GLCONST_CHAR::dwITEM_MONEY_COLOR1 );}
	if ( lnMoney >= 10000000 && lnMoney <= 99999999){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, GLCONST_CHAR::dwITEM_MONEY_COLOR2 );}
	if ( lnMoney >= 100000000 && lnMoney <= 999999999){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, GLCONST_CHAR::dwITEM_MONEY_COLOR3 );}
	if ( lnMoney >= 1000000000 && lnMoney <= 9999999999){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, GLCONST_CHAR::dwITEM_MONEY_COLOR4 );}
	if ( lnMoney >= 1000000000 && lnMoney <= 9999999999){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, GLCONST_CHAR::dwITEM_MONEY_COLOR5 );}
	if ( lnMoney >= 10000000000 && lnMoney <= 99999999999){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, GLCONST_CHAR::dwITEM_MONEY_COLOR6 );}
	if ( lnMoney >= 1000000000000 ){
		CString strTemp = NS_UITEXTCONTROL::MAKE_MONEY_FORMAT ( lnMoney, 3, "," );
		if ( m_pMoney )	m_pMoney->SetOneLineText ( strTemp, NS_UITEXTCOLOR::WHITE );}
}*/
