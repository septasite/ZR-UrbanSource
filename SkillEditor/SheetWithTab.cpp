...
void CsheetWithTab::ActiveSkillBasicPage ( int CurPage, PGLSKILL pSkill, DWORD dwAddonSel, DWORD dwSpecSel )
{
	m_SkillEditorBasicPage.SetCallPage ( CurPage );
	if (pSkill)
	{
		m_SkillEditorBasicPage.SetSkill ( pSkill, dwAddonSel, dwSpecSel );
		SetActivePage ( SKILLBASICPAGE );
	}
}

void CsheetWithTab::ActiveSkillLevelPage ( int CurPage, PGLSKILL pSkill, DWORD dwAddonSel, DWORD dwSpecSel )
{
	m_SkillEditorLevelPage.SetCallPage ( CurPage );
	if (pSkill)
	{
		m_SkillEditorLevelPage.SetSkill ( pSkill, dwAddonSel, dwSpecSel );
