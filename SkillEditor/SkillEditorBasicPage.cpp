...
BEGIN_MESSAGE_MAP(SkillEditorBasicPage, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_BUTTON_ADDONMINUS, OnBnClickedButtonAddonminus)
	ON_BN_CLICKED(IDC_BUTTON_ADDONADD, OnBnClickedButtonAddonadd)
	ON_BN_CLICKED(IDC_BUTTON_SPECMINUS, OnBnClickedButtonSpecminus)
	ON_BN_CLICKED(IDC_BUTTON_SPECADD, OnBnClickedButtonSpecadd)
END_MESSAGE_MAP()
...
void SkillEditorBasicPage::OnBnClickedButtonNext()
{
	...
	//m_SkillEditorTreePage.UpdateData ( MID,SID,m_pDummySkill );
	m_pSheetTab->ActiveSkillLevelPage ( m_CallPage,m_pDummySkill,m_dwAddonSel,m_dwSpecSel );
	m_pSkill = NULL;
}
...
BOOL SkillEditorBasicPage::SetSkill ( PGLSKILL pSkill, DWORD dwAddonSel, DWORD dwSpecSel )
{
	if ( m_pSkill )
	{
		return FALSE;
...
void SkillEditorBasicPage::InitDefaultCtrls ()
{
	...
	SetWin_Combo_Init ( this, IDC_COMBO_EMSTIGMATYPE, COMMENT::SPEC_STIGMA_TYPE, SKILL::EMSTIGMA_SIZE );
	...
	SetWin_Combo_Init ( this, IDC_COMBO_SELF03, COMMENT::SKILL_EFFTIME, SKILL::EMTIME_NSIZE );
	...
	SetWin_Combo_Init ( this, IDC_COMBO_SELFP03, COMMENT::SKILL_EFFPOS, SKILL::EMPOS_NSIZE );
...
//	SetWin_Combo_Sel ( this, IDC_COMBO_EMSTIGMATYPE, (int)m_pDummySkill->m_sBASIC.emSTIGMA_TYPE );
	...
	//SetWin_Num_int ( this, IDC_EDIT_ADDONNUM, m_pDummySkill->m_sAPPLY.dwADDONNUM );
	SetWin_Combo_Sel ( this, IDC_COMBO_EMADDON, (int)m_pDummySkill->m_sAPPLY.sadon[m_dwAddonSel].emADDON );
	//SetWin_Num_int ( this, IDC_EDIT_SPECNUM, m_pDummySkill->m_sAPPLY.dwSPECNUM );
	SetWin_Combo_Sel ( this, IDC_COMBO_EMSPEC, (int)m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC );
	...
	SetWin_Num_int ( this, IDC_EDIT_ADDONNUM2, m_dwAddonSel );
	SetWin_Num_int ( this, IDC_EDIT_SPECNUM2, m_dwSpecSel );
...
//	m_pDummySkill->m_sBASIC.emSTIGMA_TYPE = (SKILL::SPEC_STIGMA_TYPE) GetWin_Combo_Sel ( this, IDC_COMBO_EMSTIGMATYPE );
...
//	m_pDummySkill->m_sAPPLY.dwADDONNUM = GetWin_Num_int ( this, IDC_EDIT_ADDONNUM );
	m_pDummySkill->m_sAPPLY.sadon[m_dwAddonSel].emADDON = (EMIMPACT_ADDON) GetWin_Combo_Sel ( this, IDC_COMBO_EMADDON);
	//m_pDummySkill->m_sAPPLY.dwSPECNUM = GetWin_Num_int ( this, IDC_EDIT_SPECNUM );
	m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC = (EMSPEC_ADDON) GetWin_Combo_Sel ( this, IDC_COMBO_EMSPEC);
	...
	InverseUpdateSkillAddonData (m_dwAddonSel);
	InverseUpdateSkillSpecData (m_dwSpecSel);
...
void SkillEditorBasicPage::UpdateSkillSExtData (DWORD dwType)
{
	...
	SetWin_Combo_Sel ( this, IDC_COMBO_SELF03, (int)m_pDummySkill->m_sEXT_DATA.emSELFZONE03 );
	SetWin_Combo_Sel ( this, IDC_COMBO_SELFP03, (int)m_pDummySkill->m_sEXT_DATA.emSELFZONE03_POS );
	SetWin_Text ( this, IDC_EDIT_SELF03, m_pDummySkill->m_sEXT_DATA.strSELFZONE03[dwType].c_str() );
...
BOOL  SkillEditorBasicPage::InverseUpdateSkillSExtData (DWORD dwType)
{
	...
	m_pDummySkill->m_sEXT_DATA.emSELFZONE03 = (SKILL::EMEFFECTIME) GetWin_Combo_Sel ( this, IDC_COMBO_SELF03 );
	m_pDummySkill->m_sEXT_DATA.emSELFZONE03_POS = (SKILL::EMEFFECTPOS) GetWin_Combo_Sel ( this, IDC_COMBO_SELFP03);
	m_pDummySkill->m_sEXT_DATA.strSELFZONE03[dwType] = GetWin_Text( this, IDC_EDIT_SELF03 );
...
void SkillEditorBasicPage::UpdateSkillAddonData( DWORD dwAddon )
{
	SetWin_Combo_Sel ( this, IDC_COMBO_EMADDON, (int)m_pDummySkill->m_sAPPLY.sadon[dwAddon].emADDON );
	SetWin_Num_int ( this, IDC_EDIT_ADDONNUM2, dwAddon );
}

BOOL SkillEditorBasicPage::InverseUpdateSkillAddonData( DWORD dwAddon )
{
	m_pDummySkill->m_sAPPLY.sadon[dwAddon].emADDON = (EMIMPACT_ADDON) GetWin_Combo_Sel ( this, IDC_COMBO_EMADDON);
	return TRUE;
}

void SkillEditorBasicPage::UpdateSkillSpecData( DWORD dwSpec )
{
	SetWin_Combo_Sel ( this, IDC_COMBO_EMSPEC, (int)m_pDummySkill->m_sAPPLY.spec[dwSpec].emSPEC );
	SetWin_Num_int ( this, IDC_EDIT_SPECNUM2, dwSpec );
}

BOOL SkillEditorBasicPage::InverseUpdateSkillSpecData( DWORD dwSpec )
{
	m_pDummySkill->m_sAPPLY.spec[dwSpec].emSPEC = (EMSPEC_ADDON) GetWin_Combo_Sel ( this, IDC_COMBO_EMSPEC);
	return TRUE;
}
...
void SkillEditorBasicPage::OnBnClickedButtonAddonminus()
{
	InverseUpdateSkillAddonData (m_dwAddonSel);
	if ( m_dwAddonSel <= 0 ) return ;
	m_dwAddonSel--;
	UpdateSkillAddonData( m_dwAddonSel );
}

void SkillEditorBasicPage::OnBnClickedButtonAddonadd()
{
	InverseUpdateSkillAddonData (m_dwAddonSel);
	m_dwAddonSel++;
	if ( m_dwAddonSel > (DWORD) SKILL::MAX_EFFECT-1 ) m_dwAddonSel--;
	UpdateSkillAddonData( m_dwAddonSel );
}

void SkillEditorBasicPage::OnBnClickedButtonSpecminus()
{
	InverseUpdateSkillSpecData (m_dwSpecSel);
	if ( m_dwSpecSel <= 0 ) return ;
	m_dwSpecSel--;
	UpdateSkillSpecData( m_dwSpecSel );
}

void SkillEditorBasicPage::OnBnClickedButtonSpecadd()
{
	InverseUpdateSkillSpecData (m_dwSpecSel);
	m_dwSpecSel++;
	if ( m_dwSpecSel > (DWORD) SKILL::MAX_EFFECT-1 ) m_dwSpecSel--;
	UpdateSkillSpecData( m_dwSpecSel );
}
...
void SkillEditorBasicPage::OnBnClickedButtonTar03()
{
	Loadegp( IDC_EDIT_TAR03 );
}
...
void SkillEditorBasicPage::OnBnClickedButtonSelf03()
{
	Loadegp( IDC_EDIT_SELF03 );
}
