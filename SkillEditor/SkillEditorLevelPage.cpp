...
void SkillEditorLevelPage::OnBnClickedButtonNext()
{
	...
	//m_SkillEditorTreePage.UpdateData ( MID,SID,m_pDummySkill );
	m_pSheetTab->ActiveSkillBasicPage ( m_CallPage,m_pDummySkill,m_dwAddonSel,m_dwSpecSel );
	m_pSkill = NULL;
}
...
BOOL SkillEditorLevelPage::SetSkill ( PGLSKILL pSkill, DWORD dwAddonSel, DWORD dwSpecSel )
{
	if ( m_pSkill )
	{
		return FALSE;
	...
	m_dwAddonSel = dwAddonSel;
	m_dwSpecSel = dwSpecSel;
...
void SkillEditorLevelPage::InitDefaultCtrls ()
{
	...
	strTemp.Format( "Side Effect : %s" , COMMENT::IMPACT_ADDON[m_pDummySkill->m_sAPPLY.sadon[m_dwAddonSel].emADDON].c_str() );
	SetWin_Text( this ,IDC_STATIC_SDE , strTemp.GetString() );
	if ( m_pDummySkill->m_sAPPLY.sadon[m_dwAddonSel].emADDON == EMIMPACTA_NONE )
	{
	...
	strTemp.Format( "Special Ability : %s" , COMMENT::SPEC_ADDON[m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC].c_str() );
	SetWin_Text( this ,IDC_STATIC_SPA , strTemp.GetString() );

	if ( m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_NULL )
	{
	...
	strTemp.Format( "%s" , COMMENT::SPEC_ADDON_VAR1[m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC].c_str() );
	SetWin_Text( this ,IDC_STATIC_SPVAR1 , strTemp.GetString() );

	strTemp.Format( "%s" , COMMENT::SPEC_ADDON_VAR2[m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC].c_str() );
	SetWin_Text( this ,IDC_STATIC_SPVAR2 , strTemp.GetString() );

	//add new spec immune
	if ( m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_NONBLOW /* || m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_IMMUNE*/ )
	{
	...
	if ( m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_DEFENSE_SKILL_ACTIVE /*|| m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_LINKSKILL*/ )
	{
	...
	if ( m_pDummySkill->m_sSPECIAL_SKILL.emSSTYPE == SKILL::EMSSTYPE_TRANSFORM )
	{
		...
		SetWin_Enable ( this, IDC_EDIT_SUMTYPE, FALSE );
	...
	else if ( m_pDummySkill->m_sSPECIAL_SKILL.emSSTYPE == SKILL::EMSSTYPE_SUMMON )
	{
		...
		SetWin_Enable ( this, IDC_EDIT_SUMTYPE, TRUE );
...
void SkillEditorLevelPage::UpdateSkill( DWORD	m_dwSkillLevel )
{
	...
	SetWin_Num_int ( this, IDC_EDIT_RREBORN, m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].nREBORN );
	...
	//second weaponid
	SetWin_Num_int ( this, IDC_EDIT_SWEAP_MID, m_pDummySkill->m_sLEARN.sWEAPON.wMainID);
	SetWin_Num_int ( this, IDC_EDIT_SWEAP_SID, m_pDummySkill->m_sLEARN.sWEAPON.wSubID);
	...
	//side effect
	SetWin_Num_float ( this, IDC_EDIT_ADDONVAR, m_pDummySkill->m_sAPPLY.sadon[m_dwAddonSel].fADDON_VAR[ m_dwSkillLevel ] );
	
	//special ability
	SetWin_Num_float ( this, IDC_EDIT_SPVAR1, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].fVAR1 );
	SetWin_Num_float ( this, IDC_EDIT_SPVAR2, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].fVAR2 );

	//trouble cure
	SetWin_Check ( this, IDC_CHECK_TC_PARALYSIS, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_NUMB ) ;
	SetWin_Check ( this, IDC_CHECK_TC_FAINT, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_STUN );
	SetWin_Check ( this, IDC_CHECK_TC_STONE, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_STONE );
	SetWin_Check ( this, IDC_CHECK_TC_FLAME, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_BURN );
	SetWin_Check ( this, IDC_CHECK_TC_FREEZE, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_FROZEN );
	SetWin_Check ( this, IDC_CHECK_TC_MADNESS, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_MAD );
	SetWin_Check ( this, IDC_CHECK_TC_POISON, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_POISON );
	SetWin_Check ( this, IDC_CHECK_TC_CURSE, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG&DIS_CURSE );

	//active skill
	SetWin_Num_int ( this, IDC_EDIT_AS_MID, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwNativeID.wMainID );
	SetWin_Num_int ( this, IDC_EDIT_AS_SID, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwNativeID.wSubID );
	SetWin_Num_int ( this, IDC_EDIT_AS_LVL, m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG );
	...
	//summon
	SetWin_Num_int ( this, IDC_EDIT_SUMMID, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].sSummon.wMainID );
	SetWin_Num_int ( this, IDC_EDIT_SUMSID, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].sSummon.wSubID );
	SetWin_Num_float ( this, IDC_EDIT_SUMTIME, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].fSummon );
	SetWin_Num_int ( this, IDC_EDIT_SUMTYPE, m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].wSummon );
	...
	SetWin_Num_int ( this, IDC_EDIT_REQPREMP, m_pDummySkill->m_sLEARN.dwPremPoint);
...
BOOL SkillEditorLevelPage::InverseUpdateSkill( DWORD	m_dwSkillLevel )
{
	...
	m_pDummySkill->m_sLEARN.sLVL_STEP[ m_dwSkillLevel ].nREBORN = GetWin_Num_int ( this, IDC_EDIT_RREBORN ); 
	...
	//second weaponID
	m_pDummySkill->m_sLEARN.sWEAPON.wMainID = GetWin_Num_int ( this, IDC_EDIT_SWEAP_MID ); 
	m_pDummySkill->m_sLEARN.sWEAPON.wSubID = GetWin_Num_int ( this, IDC_EDIT_SWEAP_SID ); 
	...
	//side effect
	m_pDummySkill->m_sAPPLY.sadon[m_dwAddonSel].fADDON_VAR[ m_dwSkillLevel ] = GetWin_Num_float ( this, IDC_EDIT_ADDONVAR );
	
	//special ability
	m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].fVAR1 = GetWin_Num_float ( this, IDC_EDIT_SPVAR1 );
	m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].fVAR2 = GetWin_Num_float ( this, IDC_EDIT_SPVAR2 );

	//add new spec immune
	if ( m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_NONBLOW /*|| m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_IMMUNE*/ )
	{
		//trouble cure
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_PARALYSIS ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_NUMB );
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_FAINT ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_STUN );
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_STONE ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_STONE );
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_FLAME ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_BURN );
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_FREEZE ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_FROZEN );
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_MADNESS ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_MAD );
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_POISON ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_POISON );
		SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_TC_CURSE ), m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG, DIS_CURSE );
	}
	else if ( m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].emSPEC == EMSPECA_DEFENSE_SKILL_ACTIVE )
	{
		//active skill
		m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwNativeID.wMainID = GetWin_Num_int ( this, IDC_EDIT_AS_MID ); 
		m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwNativeID.wSubID = GetWin_Num_int ( this, IDC_EDIT_AS_SID ); 
		m_pDummySkill->m_sAPPLY.spec[m_dwSpecSel].sSPEC[ m_dwSkillLevel ].dwFLAG = GetWin_Num_int ( this, IDC_EDIT_AS_LVL ); 
	}
	...
	//summon
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].sSummon.wMainID = GetWin_Num_int ( this, IDC_EDIT_SUMMID );
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].sSummon.wSubID = GetWin_Num_int ( this, IDC_EDIT_SUMSID );
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].fSummon = GetWin_Num_float ( this, IDC_EDIT_SUMTIME );
	m_pDummySkill->m_sSPECIAL_SKILL.sSummon[m_dwSkillLevel].wSummon = GetWin_Num_int ( this, IDC_EDIT_SUMTYPE );
	...
	m_pDummySkill->m_sLEARN.dwPremPoint = GetWin_Num_int ( this, IDC_EDIT_REQPREMP );
