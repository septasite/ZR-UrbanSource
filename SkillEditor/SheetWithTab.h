...
public:	
	...
	void ActiveSkillBasicPage ( int CurPage, PGLSKILL pSkill, DWORD dwAddonSel, DWORD dwSpecSel );
	void ActiveSkillLevelPage ( int CurPage, PGLSKILL pSkill, DWORD dwAddonSel, DWORD dwSpecSel );
