...
namespace BugTrapServer
{
	...
	internal partial class BugTrapService : ServiceBase
	{
		...
		/// </summary>
		private const string reportNamePattern = "error_report_";
		...
		private void LoadDirectories()
		{
			...
			string reportNameFilter = BugTrapService.reportNamePattern + '*';
			foreach (string directory in directories)
			{
				...
				foreach (string file in files)
				{
					...
					if (!fileName.StartsWith(BugTrapService.reportNamePattern))
						continue;
					int reportNumber = int.Parse(fileName.Substring(BugTrapService.reportNamePattern.Length));
