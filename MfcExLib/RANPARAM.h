...
namespace RANPARAM
{
	...
	extern BOOL				bCHARACTER_SIMPLIFY;		//	부활 스킬 금지
	extern BOOL				bFPSLATENCY;		//	부활 스킬 금지
	extern BOOL				bAutoTarget;		//	부활 스킬 금지
	extern BOOL				bSkillEffects;		//	부활 스킬 금지
	...
	//extern BOOL				bAllowBet; //add duel be
	...
	extern TCHAR			Title[STRING_NUM_128];
	extern TCHAR			EmulatorName[STRING_NUM_128];
