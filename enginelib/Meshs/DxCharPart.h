...
private:
	...
	DWORD				m_dwVehicleColor1; //add vcf
...
public:
	...
	void SetVehicleColor( DWORD dwColor )		{ m_dwVehicleColor = dwColor; }
	DWORD GetVehicleColor() const				{ return m_dwVehicleColor; }

	void SetVehicleColorRev1( DWORD dwColor1 )		{ m_dwVehicleColor1 = dwColor1; }
	DWORD GetVehicleColorRev1() const				{ return m_dwVehicleColor1; }

	void SetItemColor( DWORD dwColor )		{ m_dwItemColor = dwColor; }
	DWORD GetItemColor() const				{ return m_dwItemColor; }
