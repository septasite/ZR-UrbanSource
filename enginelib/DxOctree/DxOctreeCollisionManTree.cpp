...
/*
HRESULT DxOctreeCollisionMan::GetSizeNode ( D3DXMATRIX &matComb, DWORD	*pCellIndex, DWORD nCellIndex,
...
HRESULT DxOctreeCollisionMan::GetCenterDistNode ( D3DXMATRIX &matComb, DWORD	*pCellIndex, DWORD nCellIndex,
								D3DXVECTOR3 &vMax, D3DXVECTOR3 &vMin )
{
	if ( !pCellIndex || nCellIndex < 1 )
	{
...
BOOL DxOctreeCollisionMan::IsWithInTriangle ( D3DXMATRIX &matComb,
...
HRESULT DxOctreeCollisionMan::MakeAABBNode ( DxAABBNode *pNode, D3DXMATRIX &matComb,
...
void DxOctreeCollisionMan::IsCollision ( DxAABBNode *pAABBCur, D3DXVECTOR3 &vP1, D3DXVECTOR3 &vP2, D3DXVECTOR3 &vCollision, DWORD &CollisionID )
{
...
void DxOctreeCollisionMan::IsCollision ( D3DXVECTOR3 &vPoint1, D3DXVECTOR3 &vPoint2,
...
HRESULT	DxOctreeCollisionMan::MakeAABBTree ( )
{
	HRESULT hr = S_OK;
...
void	DxOctreeCollisionMan::GetAllCollisionCell ( DWORD *pCollisionCellID, DWORD& CollisionIDCount, D3DXVECTOR3& vAMax, D3DXVECTOR3& vAMin, DxAABBNode *pAABBCur )
{
