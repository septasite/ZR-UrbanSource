...
const DWORD DxMapEditMan::VERSION_SAVE		= 0x00000001;
const DWORD	DxMapEditMan::VERSION_DATA_SAVE	= 0x00000001;
const DWORD	DxMapEditMan::VERSION_TEX_SAVE	= 0x00000001;
