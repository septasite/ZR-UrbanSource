...
DWORD		DxEffCharReflection2::VERSION_SAVE		= 0x0104;
char		DxEffCharReflection2::NAME[MAX_PATH]	= "EffCharReflection2";
...
HRESULT	DxEffCharReflection2::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice ,bool bTool,bool bRan2 )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
...
HRESULT	DxEffCharReflection2::SaveFile ( basestream &SFile ,bool bTool)
{
	SFile << TYPEID;
	SFile << VERSION_SAVE;
