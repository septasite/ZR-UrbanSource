...
#include "../Meshs/DxSkinVehicleData.h"
...
DWORD		DxEffCharLevel::VERSION			= 0x0106;
...
HRESULT DxEffCharLevel::InitDeviceObjects ( LPDIRECT3DDEVICEQ pd3dDevice )
{
	...
	// Made By : EssaeyPride (White Glow)
	// Level : 12 (+16) 노랑
	dwColorG = D3DCOLOR_ARGB( 200, 220,220,220 );	// 글로우 용
	dwColorA = D3DCOLOR_ARGB( 255, 150,150,150 );	// Ambient
	dwColorR = D3DCOLOR_ARGB( 255, 110,110,110 );	// 그 외 
	...
	// Made By : EssaeyPride (Light Orange Glow)
	// Level : 13 (+17) 노랑
	dwColorG = D3DCOLOR_ARGB( 255,255,125,0 );	// 글로우 용 -- GLOW
	dwColorA = D3DCOLOR_ARGB( 255,250,180,0 );	// Ambient -- SEMI BASE
	dwColorR = D3DCOLOR_ARGB( 255,250,200,0 );	// 그 외  -- BASE COLOR
	...
	// Made By : EssaeyPride (Purple Glow)
	// Level : 14 (+18) 노랑
	dwColorG = D3DCOLOR_ARGB( 255,148,41,255 );	// 글로우 용 -- GLOW
	dwColorA = D3DCOLOR_ARGB( 255,146,111,179 );	// Ambient -- SEMI BASE
	dwColorR = D3DCOLOR_ARGB( 255,209,163,255 );	// 그 외  -- BASE COLOR
