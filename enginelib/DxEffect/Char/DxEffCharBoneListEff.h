...
struct EFFCHAR_PROPERTY_BONELISTEFF_101
{
	DWORD		m_dwFlag;
	DWORD		m_dwParticlePec;	// 초당 나오는 파티클 갯수
	DWORD		m_dwColor;
	...
	EFFCHAR_PROPERTY_BONELISTEFF_101() :
		m_dwFlag(0L),
		m_dwParticlePec(5),
		m_dwColor(0xffffffff),
		m_dwSequenceCol(8),
...
public:
	...
	void InsertBoneTool( DXCUSTOMBONE	sCBoneNew );//add huiyi
	void	ClearAllBone ()	{	m_listCustomBone.clear(); }//add huiyi
	...
	DXCUSTOMBONE	GetSelectedBoneData( const DWORD dwIndex );//add huiyi
