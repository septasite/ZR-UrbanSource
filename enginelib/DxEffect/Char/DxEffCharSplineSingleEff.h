...
struct EFFCHAR_PROPERTY_SPLINESINGLEEFF : public EFFCHAR_PROPERTY
{
	DWORD	m_dwFlags;

	EFFCHAR_PROPERTY_SPLINESINGLEEFF () :
		m_dwFlags(0L)
	{
	}
};
...
protected:
	union
	{
		struct
		{
			EFFCHAR_PROPERTY_SPLINESINGLEEFF m_Property;
		};
...
public:
	...
	{
		m_Property = *((EFFCHAR_PROPERTY_SPLINESINGLEEFF*)pProperty);
	}
