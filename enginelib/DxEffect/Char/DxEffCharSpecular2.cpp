...
DWORD		DxEffCharSpecular2::VERSION			= 0x0106;
DWORD		DxEffCharSpecular2::VERSION_SAVE	= 0x0105;
char		DxEffCharSpecular2::NAME[MAX_PATH]	= "EffCharSpecular2";
...
HRESULT	DxEffCharSpecular2::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice ,bool bTool,bool bRan2 )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
	...
	{
		SFile >> m_dwFlag;
		SFile.ReadBuffer ( &m_cSpecular, sizeof(m_cSpecular) );
		SFile >> m_dwMaterials;
		SFile >> m_dwColorOP;
...
HRESULT	DxEffCharSpecular2::SaveFile ( basestream &SFile ,bool bTool)
{
	SFile << TYPEID;
	SFile << VERSION_SAVE;
