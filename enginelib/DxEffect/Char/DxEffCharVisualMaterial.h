...
struct EFFCHAR_PROPERTY_VISUALMATERIAL : public EFFCHAR_PROPERTY
{
	DWORD	m_dwFlags;

	EFFCHAR_PROPERTY_VISUALMATERIAL() :
		m_dwFlags(0L)
	{
	}
};
...
protected:
	union
	{
		struct
		{
			EFFCHAR_PROPERTY_VISUALMATERIAL m_Property;
		};
...
public:
	...
	{
		m_Property = *((EFFCHAR_PROPERTY_VISUALMATERIAL*)pProperty);
	}
