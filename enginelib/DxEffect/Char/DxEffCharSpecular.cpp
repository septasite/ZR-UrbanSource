...
DWORD		DxEffCharSpecular::VERSION_SAVE		= 0x0100;
char		DxEffCharSpecular::NAME[MAX_PATH]	= "EffCharSpecular";
...
HRESULT	DxEffCharSpecular::LoadFile ( basestream &SFile, LPDIRECT3DDEVICEQ pd3dDevice ,bool bTool,bool bRan2 )
{
	HRESULT hr;
	DWORD dwVer, dwSize;
...
HRESULT	DxEffCharSpecular::SaveFile ( basestream &SFile ,bool bTool)
{
	SFile << TYPEID;
	SFile << VERSION_SAVE;
