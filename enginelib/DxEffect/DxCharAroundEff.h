...
public:
	...
	void					InsertAroundEffectTool( SAROUNDEFF_DATA addData );
	...
	DWORD	GetAroundEffectSize() { return (DWORD)m_vecAroundEffList.size(); }
	void	ClearAroundEffect() { return m_vecAroundEffList.clear(); }
