...
//Added by tobets | 18-7-2012 | add mouse code
#include "./DxEffect/Single/DxEffMouseChar.h"
#include "./DxEffect/Single/DxEffMouseCrow.h"
//added by tobets2000 | 01-09-2012 | arrow target effect code
#include "./DxEffect/Single/DxTaregetEffect.h"
...
#include "./Meshs/DxSkinCharPiece.h"
#include "./Meshs/DxSkinPieceRootData.h"
//Added by tobets | 11-8-2012 | add VPS and VCF code
#include "./Meshs/DxSkinVehicle.h"
...
HRESULT DxResponseMan::OneTimeSceneInit ( const char* szAppPath, CWnd *pWndApp, CString strFontSys, DWORD dwLang, CString strFontName  )
{
	...
	case DEFAULT:
		...
		_DEFAULT_FONT_SHADOW_FLAG = D3DFONT_SHADOW;
		_DEFAULT_FONT_SHADOW_EX_FLAG = D3DFONT_SHADOW_EX;
		break;
...
HRESULT DxResponseMan::InitDeviceObjects ( LPDIRECT3DDEVICEQ pd3dDevice, BOOL bCAPTUREMOUSE )
{
	...
	//Added by tobets | 18-7-2012 | add mouse code
	DxEffMouseChar::GetInstance().InitDeviceObjects ( m_pd3dDevice );
	DxEffMouseCrow::GetInstance().InitDeviceObjects ( m_pd3dDevice );
	//added by tobets2000 | 01-09-2012 | arrow target effect code
	DxTaregetEffect::GetInstance().InitDeviceObjects ( m_pd3dDevice );
...
HRESULT DxResponseMan::RestoreDeviceObjects ()
{
	...
	//Added by tobets | 18-7-2012 | add mouse code
	DxEffMouseChar::GetInstance().RestoreDeviceObjects ();
	DxEffMouseCrow::GetInstance().RestoreDeviceObjects ();
	//added by tobets2000 | 01-09-2012 | arrow target effect code
	DxTaregetEffect::GetInstance().RestoreDeviceObjects ();
...
HRESULT DxResponseMan::FrameMove ( float fTime, float fElapsedTime, BOOL bDefWin, BOOL bGame )
{
	...
	//Added by tobets | 18-7-2012 | add mouse code
	PROFILE_BEGIN("DxEffMouseChar::FrameMove");
	DxEffMouseChar::GetInstance().FrameMove ( fTime, fElapsedTime );
	PROFILE_END("DxEffGroupChar::FrameMove");

	PROFILE_BEGIN("DxEffMouseCrow::FrameMove");
	DxEffMouseCrow::GetInstance().FrameMove ( fTime, fElapsedTime );
	PROFILE_END("DxEffGroupCrow::FrameMove");
//added by tobets2000 | 01-09-2012 | arrow target effect code
	PROFILE_BEGIN("DxTaregetEffect::FrameMove");
	DxTaregetEffect::GetInstance().FrameMove ( fTime, fElapsedTime );
	PROFILE_END("DxTaregetEffect::FrameMove");
...
HRESULT DxResponseMan::InvalidateDeviceObjects ()
{
	...
	//Added by tobets | 18-7-2012 | add mouse code
	DxEffMouseChar::GetInstance().InvalidateDeviceObjects ();
	DxEffMouseCrow::GetInstance().InvalidateDeviceObjects ();
	//added by tobets2000 | 01-09-2012 | arrow target effect code
	DxTaregetEffect::GetInstance().InvalidateDeviceObjects ();
...
HRESULT DxResponseMan::DeleteDeviceObjects ()
{
	...
	//Added by tobets | 18-7-2012 | add mouse code
	DxEffMouseChar::GetInstance().DeleteDeviceObjects ();
	DxEffMouseCrow::GetInstance().DeleteDeviceObjects ();
	//added by tobets2000 | 01-09-2012 | arrow target effect code
	DxTaregetEffect::GetInstance().DeleteDeviceObjects ();
