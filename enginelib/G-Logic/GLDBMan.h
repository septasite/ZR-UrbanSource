...
struct SLOGITEMCONVERSION
{
	...
	bool		m_bWrap; // wrapper
	bool		m_bNonDrop; //nondrop card Eduj
	...
	SLOGITEMCONVERSION (
		...
		, m_nElectric(_nElectric)
		, m_nSpirit(_nSpirit)
		, m_bWrap( _bWrap ) // wrapper
		, m_bNonDrop ( _bNonDrop )
	{
	}
};
...
public:
	...
	*/
	...
	virtual int SetChaSchool(DWORD dwChaNum, int nSchool) { return 0; }
	...
	*/	
	...
	virtual int SetPetSkill(
		...
		int nPetInvenSlotIndex) { return 0; }
