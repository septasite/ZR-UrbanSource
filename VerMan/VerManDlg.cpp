...
BEGIN_MESSAGE_MAP(CVerManDlg, CDialog)
	...
	ON_EN_CHANGE(IDC_EDIT_PATCH, OnEnChangeEditPatch)
	ON_EN_CHANGE(IDC_EDIT_CLIENT, OnEnChangeEditClient)
END_MESSAGE_MAP()
...
void CVerManDlg::OnEnChangeEditPatch()
{
...
void CVerManDlg::OnEnChangeEditClient()
{
	// TODO:  If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialog::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
