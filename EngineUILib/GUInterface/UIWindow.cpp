...
void CUIWindow::CreateTitleNoShadow ( char* szFrame, char* szLeft, char* szMid, char* szRight, char* szTextBox, const char* szText )
{
	int FONTSIZE = 8;
	if ( CUIMan::m_bBIGFONT ) FONTSIZE = 9;
	CD3DFontPar* pFont = DxFontMan::GetInstance().LoadDxFont ( _DEFAULT_FONT, FONTSIZE, _DEFAULT_FONT_FLAG );
