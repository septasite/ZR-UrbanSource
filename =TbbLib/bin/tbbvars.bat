...
REM
IF NOT DEFINED TBB20_INSTALL_DIR SET TBB20_INSTALL_DIR=SUBSTITUTE_INSTALL_DIR_HERE
SET TBB_ARCH_PLATFORM=ia32\vc7.1
SET PATH=%TBB20_INSTALL_DIR%\%TBB_ARCH_PLATFORM%\bin;%PATH%
SET LIB=%TBB20_INSTALL_DIR%\%TBB_ARCH_PLATFORM%\lib;%LIB%
SET INCLUDE=%TBB20_INSTALL_DIR%\include;%INCLUDE%
