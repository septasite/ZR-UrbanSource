		...
		if(Process32First(hProcessSnap, &pe32))
		{
			do
			{
				...
				if(hProcess != NULL)
				{
					...
					{
						MessageBoxA(FindWindowA(0,"Ran Online"), "Found hack software in your system.\n\nHint: Close all illegal programs and run application again.", "Game Guard", MB_OK | MB_ICONSTOP);
						ExitProcess(1);
					}
				}
			}
