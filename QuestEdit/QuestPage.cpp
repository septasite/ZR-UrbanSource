...
void CQuestPage::UpdateItems ()
{
	...
	SetWin_Check ( this, IDC_CHECK_ASSASIN_M3, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_ASSASSIN_M) ); 
	SetWin_Check ( this, IDC_CHECK_ASSASIN_W3, (CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS&GLCC_ASSASSIN_W) );
...
void CQuestPage::InverseUpdateItems ()
{
	...
	GetWin_Check ( this, IDC_CHECK_ASSASIN_M3, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_ASSASSIN_M ); 
	GetWin_Check ( this, IDC_CHECK_ASSASIN_W3, CQuestEditDlg::m_sQuestNode.pQUEST->m_sSTARTOPT.dwCLASS, GLCC_ASSASSIN_W ); 
