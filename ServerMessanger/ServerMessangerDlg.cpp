...
CServerMessangerDlg::CServerMessangerDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CServerMessangerDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CServerMessangerDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
void CServerMessangerDlg::MsgProcess(NET_MSG_GENERIC* nmg)
{	
}