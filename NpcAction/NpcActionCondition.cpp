...
BOOL CNpcActionCondition::InverseUpdateItems ()
{
	...
	GetWin_Check ( this, IDC_CHECK_EXTREME_M3, m_DummyCondition.m_dwClass, GLCC_ASSASSIN_M );
	GetWin_Check ( this, IDC_CHECK_EXTREME_W3, m_DummyCondition.m_dwClass, GLCC_ASSASSIN_W );
...
void CNpcActionCondition::UpdateItems ()
{
	...
	SetWin_Check ( this, IDC_CHECK_EXTREME_M3, (m_DummyCondition.m_dwClass&GLCC_ASSASSIN_M) );
	SetWin_Check ( this, IDC_CHECK_EXTREME_W3, (m_DummyCondition.m_dwClass&GLCC_ASSASSIN_W) );
