...
public:
	...
	void OpenSelectFolder(int i);
	BOOL RunEncryptFile( const CString& strInput, const CString& strOutput );
	BOOL RunEncryptFolder( const CString& strInput, const CString& strOutput , const CString& strSearchPattern );
	BOOL RunDecryptFile( const CString& strInput, const CString& strOutput );
	BOOL RunDecryptFolder( const CString& strInput, const CString& strOutput,const CString& strSearchPattern );
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedButton_SOURCE();
	int TXTSOURCE;
	int TXTDESTINATION;
	afx_msg void OnBnClickedButton_DEST();
