...
void CRanManagerUserEdit::LoadUser(int nNum )
{
	...
	_snprintf( szTemp, 1024, 
		...
		"ChaName,UserBlock,UserBlockDate,ChaRemain,ChaTestRemain,PremiumDate,ChatBlockDate,UserEmail,UserPoint,OfflineTime,GameTime3"
...
void CRanManagerUserEdit::OnBnClickedBtnEditSave()
{
	...
	_snprintf( szTemp, 1024, 
		...
		"ChaName='%s',UserBlock=%d,UserBlockDate='%s',ChaRemain=%d,ChaTestRemain=%d,PremiumDate='%s',ChatBlockDate='%s',UserEmail='%s',UserPoint=%d "
		"  WHERE UserNum =%d "
