...
namespace DxFieldInstance
{
					 ...
					 DWORD dwLangSet )
	{
		...
		GLSchoolWarsFieldMan::GetInstance().Load ( GLCONST_CHAR::vecSW_FILE);
		GLRoyalRumbleFieldMan::GetInstance().Load ( GLCONST_CHAR::vecRR_FILE);
	...
	HRESULT FrameMove ()
	{
		...
		GLSchoolWarsFieldMan::GetInstance().FrameMove( fElapsedAppTime );
		GLRoyalRumbleFieldMan::GetInstance().FrameMove( fElapsedAppTime );
		GLTowerWarsFieldMan::GetInstance().FrameMove( fElapsedAppTime );
...
namespace DxAgentInstance
{
					 ...
					 DWORD dwLangSet )
	{
		...
		GLSchoolWarsAgentMan::GetInstance().Load ( GLCONST_CHAR::vecSW_FILE );
		GLRoyalRumbleAgentMan::GetInstance().Load ( GLCONST_CHAR::vecRR_FILE );
	...
	HRESULT FrameMove()
	{
		...
		GLSchoolWarsAgentMan::GetInstance().FrameMove ( fElapsedAppTime );
		GLRoyalRumbleAgentMan::GetInstance().FrameMove ( fElapsedAppTime );
