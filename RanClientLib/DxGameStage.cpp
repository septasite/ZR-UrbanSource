...
#include "../EngineLib/DxEffect/Single/DxEffMouseChar.h"
#include "../EngineLib/DxEffect/Single/DxEffMouseCrow.h"
//added by   | 01-09-2012 | arrow target effect code
#include "../EngineLib/DxEffect/Single/DxTaregetEffect.h"
...
HRESULT DxGameStage::Render ()
{
	...
	//Added by   | 18-7-2012 | Add Mouse effect code
	PROFILE_BEGIN2("DxEffMouseChar::Render");
	DxEffMouseChar::GetInstance().Render ( m_pd3dDevice );
	PROFILE_END2("DxEffMouseChar::Render");

	PROFILE_BEGIN2("DxEffMouseCrow::Render");
	DxEffMouseCrow::GetInstance().Render ( m_pd3dDevice );
	PROFILE_END2("DxEffMouseCrow::Render");
//added by   | 01-09-2012 | arrow target effect code
	PROFILE_BEGIN2("DxTaregetEffect::Render");
	DxTaregetEffect::GetInstance().Render ( m_pd3dDevice );
	PROFILE_END2("DxTaregetEffect::Render");
	// Note : 최적화한 Eff
