...
HRESULT DxGlobalStage::ChangeStage ( WORD wWidth, WORD wHeight )
{
	...
	{
	case EM_STAGE_LOBY:
		strLoadingImageName = _T("loading_000.dds");
		strMapName = _T("");
		break;
	...
	case EM_STAGE_GAME:
		{
			...
			strMapName = pMapNode->strMapName;
		}
		break;
	};
...
void DxGlobalStage::MsgProcessFrame ( NET_MSG_GENERIC *nmg )
{
	...
	//link skill
	case NET_MSG_GCTRL_REQ_LINKSKILLEFF_FB:
	case NET_MSG_GCTRL_REQ_LINKSKILLEFF_BRD:	
	...
	case NET_MSG_AP_DT_BRD: // Detect AutoPots Global Announcement - Eduj
//	case NET_MSG_GCTRL_INVEN_GRINDING_BRD: // global grind - Eduj
	case NET_MSG_INVEN_NONDROP_BRD: // miss this you'll die - Eduj
	case NET_MSG_INVEN_REMOVE_NONDROP_BRD: // miss this you'll die - Eduj
	...
	case NET_MSG_GCTRL_INVEN_SCHOOL_CHANGE_FB: //change school

	case NET_MSG_GCTRL_INVEN_SCHOOL_CHANGE_BRD: //change school

	//disable skill effect NaJDeV
