...
enum EMCROWMAP
{
	...
	EMCROWMAP_CLUBMAN		= 4,
	EMCROWMAP_POSTBOX		= 5,
	EMCROWMAP_LANDMARK		= 6,
	EMCROWMAP_SAVEPOINT		= 7,
	EMCROWMAP_SIZE			= 8,	
};
...
public:
	...
	BOOL Load_0107( basestream &SFile );//ph 845
...
public:
	...
	BOOL LoadFile_106 ( basestream &SFile );
	BOOL LoadFile_107 ( basestream &SFile );
