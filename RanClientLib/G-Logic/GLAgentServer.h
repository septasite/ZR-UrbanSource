...
private:
	...
	//add sw buff
	BOOL MsgSwCertified ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID );
	...
	BOOL MsgGmSlotEVENT ( NET_MSG_GENERIC* nmg, DWORD dwClientID, DWORD dwGaeaID ); 
	...
	BOOL MsgWPEDetectedBrd ( NET_MSG_GENERIC* nmg ); 	// Detect AutoPots Global Announcement - Eduj
	BOOL MsgAPDetectedBrd ( NET_MSG_GENERIC* nmg ); 	// Detect AutoPots Global Announcement - Eduj
	BOOL MsgClubCDCertifyBrd ( NET_MSG_GENERIC* nmg );
	BOOL MsgNonDropBrd ( NET_MSG_GENERIC* nmg ); 
	BOOL MsgRemoveNonDropBrd ( NET_MSG_GENERIC* nmg ); 
	...
	BOOL MsgTowerWarsSetWinner( NET_MSG_GENERIC* nmg );
