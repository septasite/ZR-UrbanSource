...
bool CGLCommentFile::LOADFILE( const char * szFileName )
{
	...
	{
		cFILE.getflag( "CharDefine", "CHARCLASS", i, GLCI_NUM_NEWEST, COMMENT::CHARCLASS[i]);
		cFILE.getflag( "CharDefine", "CHARCOMMENT", i, GLCI_NUM_NEWEST, COMMENT::CHARCOMMENT[i]);
	}
	...
	cFILE.getflag( "SummonDefine", "SUMMON_TYPE", i, SUMMON_TYPE_SIZE, COMMENT::SUMMON_TYPE[i] );
