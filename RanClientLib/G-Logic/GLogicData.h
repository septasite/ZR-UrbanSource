...
enum GLCONST
{
	...
	//added by   | 20-6-2012 | increase refining
	GRADE_NORMAL		= 4,
	GRADE_HIGH			= 9,
	GRADE_LIMIT_MAX		= 18,
};
...
namespace GLCONST_CHAR
{
	...
	extern float		fCHAR_HEIGHT[GLCI_NUM_NEWEST];
...
//	extern float		fDISPRICE;				//	아이템 재판매 가격.
	...
	extern DWORD 	 	 dwCHAT_NORMAL_COLOR; 
 	extern DWORD 	 	 dwCHAT_PRIVATE_COLOR; 
 	extern DWORD 	 	 dwCHAT_GUILD_COLOR; 
 	extern DWORD 	 	 dwCHAT_TOALL_COLOR; 
 	extern DWORD 	 	 dwCHAT_PARTY_COLOR; 
 	extern DWORD 	 	 dwCHAT_ALLIANCE_COLOR; 
 	extern DWORD 	 	 dwCHAT_SYSTEM_COLOR; 
 	extern DWORD 	 	 dwCHAT_ADMIN_COLOR; 
	
	extern DWORD 	 	 dwITEM_MONEY_COLOR0; 
	extern DWORD 	 	 dwITEM_MONEY_COLOR1; 
	extern DWORD 	 	 dwITEM_MONEY_COLOR2; 
	extern DWORD 	 	 dwITEM_MONEY_COLOR3; 
	extern DWORD 	 	 dwITEM_MONEY_COLOR4; 
	extern DWORD 	 	 dwITEM_MONEY_COLOR5; 
	extern DWORD 	 	 dwITEM_MONEY_COLOR6; 
	extern DWORD 	 	 dwITEM_MONEY_COLOR7;
	...
	extern BOOL			bSCHOOL_WAR;			//	클럽 데스매치 가능 여부
	extern DWORD		dwSCHOOL_WAR_MEM;
	...
	extern std::string strPKStreak;
	extern std::string strPKStreak1;
	extern std::string strPKStreak2;
	extern std::string strPKStreak3;
//add stats limit
	...
	extern std::string	strBULLETSELF_EFFECT;		//	몹 사라지는 이팩트.
	...
	extern std::string	strCLICK_EFFECT;		//added by :   | 05-03-2012 | added mouse effect for char
	extern std::string	strTARGET_EFFECT;		//added by :   | 05-03-2012 | added mouse effect for mob
	extern std::string	strMINE_EFFECT;			//added by :   | 05-03-2012 | added item drop effect
	extern std::string	strGUI_ATTACK_AREA_CIRCLE_EFFECT;			//added by :   | 07-13-2013 | added aoe effect

		extern std::string	strTARGET_EFFECT_ENEMY;		//added by :   | 05-03-2012 | added new mouse effect for mob
	extern std::string	strTARGET_EFFECT_NPC;		//added by :   | 05-03-2012 | added new mouse effect for mob
	extern std::string	strTARGET_EFFECT_ALLIANCE;		//added by :   | 05-03-2012 | added new mouse effect for mob
	extern std::string	strARROW_EFFECT_ENEMY;		//added by :   | 05-03-2012 | added new mouse effect for mob
	extern std::string	strARROW_EFFECT_NPC;		//added by :   | 05-03-2012 | added new mouse effect for mob
	extern std::string	strARROW_EFFECT_ALLIANCE;		//added by :   | 05-03-2012 | added new mouse effect for mob
	extern std::string	strBULLET_EFFECT;

	extern bool		bLINKNONTRADE;
	...
	extern GLCONST_CHARCLASS	cCONSTCLASS[GLCI_NUM_NEWEST];	//	캐릭터 클래스별 상수.

	extern std::string strCLASS_INIT[MAX_SCHOOL][GLCI_NUM_NEWEST];
	...
	extern char					szCharSkin[GLCI_NUM_NEWEST][MAX_PATH];	//	캐릭별 초기 형상.
...
namespace HAIRCOLOR
{
	...
	extern WORD wHairColor[GLCI_NUM_NEWEST][MAXHAIRCOLOR];
