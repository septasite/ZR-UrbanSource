...
public:
	...
	virtual bool IsImmune () const { return false; }		//dmk14 | 9-11-16 | immune
	...
	virtual void ReceivePushPull ( const D3DXVECTOR3 &vMovePos, const bool bReact , const bool bAdjustSpeed , const float fSpeed, const  bool  bDash, const  bool  bTeleport ) = 0; //add pushpull
	...
	virtual void BUFF_REMOVE( DWORD dwBuffFlag, const SNATIVEID skill_id ) = 0;
