...
EMANI_MAINTYPE GLVEHICLE::GetVehicleMainAni ( VEHICLE_TYPE	m_emTYPE )
{
	...
	case VEHICLE_TYPE_BIKE_FERRARI:
		emANIMAINTYPE = AN_FERRARI;
		break;

	case VEHICLE_TYPE_BIKE_REAR:
		emANIMAINTYPE = AN_REARCAR;
		break;
...
namespace COMMENT
{
	extern std::string VEHICLE_TYPE[VEHICLE_TYPE_SIZE] = { "HoverBoard", "Scooter", "BT5", "BT7", "BT9", "Rare", "Xmas", "Ghost", "Joker", "Ferrari", "Rear" };
};