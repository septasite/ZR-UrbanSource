...
struct GLQUEST_STEP
{
	...
	GLQUEST_STEP () :
		m_strTITLE("Title of Current Quest"),
		m_strCOMMENT("Description"),

		m_strOBJ_NPCTALK("Talk To NPC"),
		m_dwNID_NPCTALK(UINT_MAX),

		m_strOBJ_MOBKILL("Kill Monsters"),
		m_dwNID_MOBKILL(UINT_MAX),
		m_dwNUM_MOBKILL(0),

		m_strOBJ_MOBGEN_QITEM("MobGen Quest Item"),

		m_strOBJ_NPCGUARD("Defend NPC"),
		m_dwNID_NPCGUARD(UINT_MAX),

		m_strOBJ_REACH_ZONE("Reach Map or Location"),
		m_sMAPID_REACH(false),
		m_wPOSX_REACH(0),
		m_wPOSY_REACH(0),
		m_wRADIUS_REACH(60),

		m_strOBJ_DEFENSE_ZONE("Defend Map Or Location"),
