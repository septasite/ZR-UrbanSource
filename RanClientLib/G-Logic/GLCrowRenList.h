...
namespace CROWCOLOR
{
	...
	const DWORD MOB_COLOR_YELLOW	= D3DCOLOR_ARGB(0xFF,0xFF,0xFF,0x00);
	const DWORD MOB_COLOR_ORANGERED		= D3DCOLOR_ARGB(0xFF,0xFF,0x45,0x00);
	const DWORD	MOB_COLOR_LIGHTSKYBLUE	= D3DCOLOR_ARGB(0xFF,0x87,0xCE,0xFA);
	const DWORD MOB_COLOR_VIOLET			= D3DCOLOR_ARGB(0xFF,0xEE,0x82,0xEE);
	const DWORD MOB_COLOR_AQUAMARINE		= D3DCOLOR_ARGB(0xFF,0x7F,0xFF,0xD4);
	const DWORD MOB_COLOR_DODGERBLUE		= D3DCOLOR_ARGB(0xFF,0x1E,0x90,0xFF);
	const DWORD MOB_COLOR_FORESTGREEN		= D3DCOLOR_ARGB(0xFF,0x22,0x8B,0x22);
	const DWORD MOB_COLOR_ORANGE			= D3DCOLOR_ARGB(0xFF,0xFF,0xA5,0x00);
	const DWORD MOB_COLOR_IDNAMECOLOR			= D3DCOLOR_ARGB(0xFF,0x00,0xA8,0xFF);
};
