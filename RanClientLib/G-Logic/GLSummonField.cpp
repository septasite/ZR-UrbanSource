...
void GLSummonField::ReceivePushPull ( const D3DXVECTOR3 &vMovePos, const bool bReact , const bool bAdjustSpeed , const float fSpeed, const  bool  bDash, const  bool  bTeleport ) //add pushpull
{
