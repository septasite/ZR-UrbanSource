...
namespace GLCONST_CHAR
{
	BOOL	LOADFILE ( char* szFileName, BOOL bServer )
	{
		...
		if( GLOGIC::bGLOGIC_ZIPFILE ) // by 경?E
...
//		cFILE.getflag( "fDISPRICE", 1, 1, fDISPRICE );
		...
		for ( i=0; i<GLCI_NUM_NEWEST; ++i )// 
			cFILE.getflag( "fCHAR_HEIGHT", i+1, GLCI_NUM_NEWEST, fCHAR_HEIGHT[i] );// 
		...
		cFILE.getflag( "bSCHOOL_WAR", 1, 1, bCLUB_DEATHMATCH );
		cFILE.getflag( "dwSCHOOL_WAR_MEM", 1, 1, dwCLUB_DEATHMATCH_MEM );	
		...
		//Normal Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_NORMAL_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_NORMAL_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_NORMAL_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_NORMAL_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_NORMAL_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA); 

		 //Private Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_PRIVATE_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_PRIVATE_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_PRIVATE_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_PRIVATE_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_PRIVATE_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA); 

		 //Guild Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_GUILD_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_GUILD_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_GUILD_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_GUILD_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_GUILD_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA); 

		 //Shout Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_TOALL_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_TOALL_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_TOALL_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_TOALL_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_TOALL_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA); 

		 //Party Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_PARTY_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_PARTY_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_PARTY_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_PARTY_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_PARTY_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA); 

		 //Alliance Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_ALLIANCE_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_ALLIANCE_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_ALLIANCE_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_ALLIANCE_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_ALLIANCE_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA); 

		 //System Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_SYSTEM_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_SYSTEM_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_SYSTEM_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_SYSTEM_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_SYSTEM_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA); 
 
 	 	 //Admin Chat Color by SeiferXIII
 	 	 cFILE.getflag( "CHAT_ADMIN_COLOR", 1, 4, cA ); 
 	 	 cFILE.getflag( "CHAT_ADMIN_COLOR", 2, 4, cR ); 
 	 	 cFILE.getflag( "CHAT_ADMIN_COLOR", 3, 4, cG ); 
 	 	 cFILE.getflag( "CHAT_ADMIN_COLOR", 4, 4, cB ); 
 	 	 dwCHAT_ADMIN_COLOR = D3DCOLOR_RGBA(cR,cG,cB,cA);
		 
		   //Item Money Color by EssaeyPride
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR1", 1, 4, cA ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR1", 2, 4, cR ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR1", 3, 4, cG ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR1", 4, 4, cB ); 
 	 	 dwITEM_MONEY_COLOR1 = D3DCOLOR_RGBA(cR,cG,cB,cA);

		  //Item Money Color by EssaeyPride
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR2", 1, 4, cA ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR2", 2, 4, cR ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR2", 3, 4, cG ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR2", 4, 4, cB ); 
 	 	 dwITEM_MONEY_COLOR2 = D3DCOLOR_RGBA(cR,cG,cB,cA);

		  //Item Money Color by EssaeyPride
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR3", 1, 4, cA ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR3", 2, 4, cR ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR3", 3, 4, cG ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR3", 4, 4, cB ); 
 	 	 dwITEM_MONEY_COLOR3 = D3DCOLOR_RGBA(cR,cG,cB,cA);

		  //Item Money Color by EssaeyPride
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR4", 1, 4, cA ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR4", 2, 4, cR ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR4", 3, 4, cG ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR4", 4, 4, cB ); 
 	 	 dwITEM_MONEY_COLOR4 = D3DCOLOR_RGBA(cR,cG,cB,cA);

		  //Item Money Color by EssaeyPride
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR5", 1, 4, cA ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR5", 2, 4, cR ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR5", 3, 4, cG ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR5", 4, 4, cB ); 
 	 	 dwITEM_MONEY_COLOR5 = D3DCOLOR_RGBA(cR,cG,cB,cA);

		  //Item Money Color by EssaeyPride
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR6", 1, 4, cA ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR6", 2, 4, cR ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR6", 3, 4, cG ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR6", 4, 4, cB ); 
 	 	 dwITEM_MONEY_COLOR6 = D3DCOLOR_RGBA(cR,cG,cB,cA);

		  //Item Money Color by EssaeyPride
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR7", 1, 4, cA ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR7", 2, 4, cR ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR7", 3, 4, cG ); 
 	 	 cFILE.getflag( "ITEM_MONEY_COLOR7", 4, 4, cB ); 
 	 	 dwITEM_MONEY_COLOR7 = D3DCOLOR_RGBA(cR,cG,cB,cA);
		...
		cFILE.getflag( "llVEND_PRICE_MAX", 1, 1, llVEND_PRICE_MAX ); //  

		cFILE.getflag( "m_sCP_MAX", 1, 1, m_sCP_MAX );//add cp
		cFILE.getflag( "dwCP_RATE", 1, 1, dwCP_RATE );//add cp
		...
		cFILE.getflag( "strPKStreak", 1, 1, strPKStreak);
		cFILE.getflag( "strPKStreak1", 1, 1, strPKStreak1);
		cFILE.getflag( "strPKStreak2", 1, 1, strPKStreak2);
		cFILE.getflag( "strPKStreak3", 1, 1, strPKStreak3);
		...
		cFILE.getflag( "strBULLETSELF_EFFECT",	1, 1, strBULLETSELF_EFFECT );	
		...
		cFILE.getflag( "strCLICK_EFFECT",	1, 1, strCLICK_EFFECT );	//added by :   | 05-03-2012 | added mouse effect for char
		cFILE.getflag( "strTARGET_EFFECT",	1, 1, strTARGET_EFFECT );	//added by :   | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strMINE_EFFECT",	1, 1, strMINE_EFFECT );		//added by :   | 05-03-2012 | added item drop effect
		cFILE.getflag( "strGUI_ATTACK_AREA_CIRCLE_EFFECT",	1, 1, strGUI_ATTACK_AREA_CIRCLE_EFFECT );	//added by :   | 07-13-2013 | added aoe effect

		cFILE.getflag( "strTARGET_EFFECT_ENEMY",	1, 1, strTARGET_EFFECT_ENEMY );	//added by :   | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strTARGET_EFFECT_NPC",	1, 1, strTARGET_EFFECT_NPC );	//added by :   | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strTARGET_EFFECT_ALLIANCE",	1, 1, strTARGET_EFFECT_ALLIANCE );	//added by :   | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strARROW_EFFECT_ENEMY",	1, 1, strARROW_EFFECT_ENEMY );	//added by :   | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strARROW_EFFECT_NPC",	1, 1, strARROW_EFFECT_NPC );	//added by :   | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strARROW_EFFECT_ALLIANCE",	1, 1, strARROW_EFFECT_ALLIANCE );	//added by :   | 05-03-2012 | added mouse effect for mob
		cFILE.getflag( "strBULLET_EFFECT",	1, 1, strBULLET_EFFECT );	

		cFILE.getflag( "bLINKNONTRADE", 1, 1, bLINKNONTRADE ); 
...
// 
		const char* szSETFILE[GLCI_NUM_NEWEST] = 
		{
			"FIGHTER_M.SETFILE",
			"ARMS_M.SETFILE",
			"ARCHER_W.SETFILE",
		...
		for ( i=0; i<wSCHOOLNUM; ++i )
		{
			for ( WORD j=0; j<GLCI_NUM_NEWEST; ++j )// 
			{
				...
				cFILE.getflag( strKEY.GetString(), 1+j, GLCI_NUM_NEWEST, strCLASS_INIT[i][j] );	
// 
			}
		}
		...
		const char* szSKILFILE[GLCI_NUM_NEWEST] = // 
		{
			"FIGHTER_M.SKINFILE",
			"ARMS_M.SKINFILE",
			"ARCHER_W.SKINFILE",
	...
	BOOL	EXP_LOADFILE ( char* szFileName )
	{
		...
		if( GLOGIC::bGLOGIC_ZIPFILE ) // by 경?E
			cFILE.SetZipFile( GLOGIC::strGLOGIC_SERVER_ZIPFILE ); // by 경?E zip파일 사?E
		...
		for ( WORD i=1; i<EXPTABLE_SIZE+1; ++i )
		{
			...
			//strBuffer.freeze( false );	// Note : std::strstream의 freeze. 안 하?ELeak 발생.
		}
