...
enum EMCLUB_BATTLE_REQ_FB
{
	...
	EMCLUB_BATTLE_REQ_FB_CTFMAP			= 22,
};
...
enum EMALLIANCE_BATTLE_REQ_FB
{
	...
	EMALLIANCE_BATTLE_REQ_FB_CTFMAP			= 22,
};
...
enum EMCLUB_BATTLE_ARMISTICE_REQ_FB
{
	...
	EMCLUB_BATTLE_ARMISTICE_FB_CTFMAP		= 10,
};
...
enum EMALLIANCE_BATTLE_ARMISTICE_REQ_FB
{
	...
	EMALLIANCE_BATTLE_ARMISTICE_FB_CTFMAP		= 10,
};
...
enum EMCLUB_BATTLE_SUBMISSION_REQ_FB
{
	...
	EMCLUB_BATTLE_SUBMISSION_FB_CTFMAP		= 8,
};
...
enum EMALLIANCE_BATTLE_SUBMISSION_REQ_FB
{
	...
	EMALLIANCE_BATTLE_SUBMISSION_FB_CTFMAP		= 8,
};
