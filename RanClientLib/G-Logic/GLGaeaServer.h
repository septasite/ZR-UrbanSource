...
{
	float fItemGainRate[GLCI_NUM_NEWEST];
	float fExpGainRate[GLCI_NUM_NEWEST];
	float fMoneyGainRate[GLCI_NUM_NEWEST];
// 
	DWORD dwExpMinLevel[GLCI_NUM_NEWEST];
	DWORD dwExpMaxLevel[GLCI_NUM_NEWEST];
	DWORD dwItemMinLevel[GLCI_NUM_NEWEST];
	DWORD dwItemMaxLevel[GLCI_NUM_NEWEST];
	DWORD dwMoneyMinLevel[GLCI_NUM_NEWEST];
	DWORD dwMoneyMaxLevel[GLCI_NUM_NEWEST];
...
public:
	...
	BOOL	ReqRoyalRumblePRanking ( DWORD dwClientID, DWORD dwGaeaID, GLMSG::SNET_ROYAL_RUMBLE_PRANKING_REQ* pNetMsg );
...
public:
	...
	BOOL ServerSchoolWarsReady	( GLMSG::SNET_SCHOOL_WARS_READY_FLD *pNetMsg );
	BOOL ServerSchoolWarsStart	( GLMSG::SNET_SCHOOL_WARS_START_FLD *pNetMsg );
	BOOL ServerSchoolWarsEnd	( GLMSG::SNET_SCHOOL_WARS_END_FLD *pNetMsg );
	//add sw buff
	BOOL ServerSwCertify ( GLMSG::SNET_SCHOOL_WARS_CERTIFIED_FLD *pNetMsg );

	BOOL ServerRoyalRumbleReady	( GLMSG::SNET_ROYAL_RUMBLE_READY_FLD *pNetMsg );
	BOOL ServerRoyalRumbleStart	( GLMSG::SNET_ROYAL_RUMBLE_START_FLD *pNetMsg );
	BOOL ServerRoyalRumbleEnd	( GLMSG::SNET_ROYAL_RUMBLE_END_FLD *pNetMsg );

	BOOL ServerTowerWarsWinner ( GLMSG::SNET_TOWERWARS_WINNER_FLD *pNetMsg );
	...
	BOOL ReqCrowList ( DWORD dwClientID, DWORD dwGaeaID, GLMSG::SNETPC_REQ_CROWLIST_FLD *pNetMsg ); //Request Crow List NaJDeV
...
//	BOOL GlobalUpgrade ( GLMSG::SNET_GLOBAL_SUCCESS_GRIND*pNetMsg );
	...
	//HRESULT MsgReqHoldArrayToInven ( NET_MSG_GENERIC* nmg );
...
public:
	...
	BOOL GMCtrlSlotEVENT ( DWORD dwClientID, DWORD dwGaeaID, GLMSG::SNET_GM_SLOT_EVENT_FLD* pNetMsg );
