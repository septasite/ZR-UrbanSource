	...
	case NET_MSG_GCTRL_CLUB_RANK_FB:
		{
			...
			case EMCLUB_RANK_FB_OK:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::PALEGREEN, ID2GAMEINTEXT("EMCLUB_RANK_FB_OK") );
				break;
	...
	case NET_MSG_GCTRL_CLUB_MEMBER_NICK_FB:
		{
			...
			case EMCLUB_MEMBER_NICK_FB_OK:
				{
					CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::PALEGREEN, ID2GAMEINTEXT("EMCLUB_MEMBER_NICK_FB_OK") );
	...
	case NET_MSG_GCTRL_CLUB_SUBMASTER_FB:
		{
			...
			case EMCLUBSUBMASTER_FB_CDM_MEM:
				...
				break;
			/*case EMCLUBSUBMASTER_FB_SW_MEM:
				{
					CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMCLUBSUBMASTER_FB_SW_MEM") );
				}
				break;*/
			};
		}
