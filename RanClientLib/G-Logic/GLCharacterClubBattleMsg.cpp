	...
	case NET_MSG_GCTRL_CLUB_BATTLE_REQ_FB:
		{
			...
			case EMCLUB_BATTLE_REQ_FB_CDMMAP:
				...
				break;
			case EMCLUB_BATTLE_REQ_FB_CTFMAP:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMCLUB_BATTLE_REQ_FB_CTFMAP") );
				break;
			}
		}
		break;
	...
	case NET_MSG_GCTRL_CLUB_BATTLE_ARMISTICE_REQ_FB:
		{
			...
			case EMCLUB_BATTLE_ARMISTICE_FB_CTFMAP:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMCLUB_BATTLE_ARMISTICE_FB_CTFMAP") );
				break;
			}			
		}
		break;
	...
	case NET_MSG_GCTRL_CLUB_BATTLE_SUBMISSION_REQ_FB:
		{
			...
			case EMCLUB_BATTLE_SUBMISSION_FB_CTFMAP:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMCLUB_BATTLE_SUBMISSION_FB_CTFMAP") );
				break;
			}
		}
		break;
	...
	case NET_MSG_GCTRL_ALLIANCE_BATTLE_REQ_FB:
		{
			...
			case EMALLIANCE_BATTLE_REQ_FB_CTFMAP:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMALLIANCE_BATTLE_REQ_FB_CTFMAP") );
				break;
			}
		}
		break;
	...
	case NET_MSG_GCTRL_ALLIANCE_BATTLE_ARMISTICE_REQ_FB:
		{
			...
			case EMALLIANCE_BATTLE_ARMISTICE_FB_CTFMAP:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMALLIANCE_BATTLE_ARMISTICE_FB_CTFMAP") );
				break;
			}			
		}
		break;
	...
	case NET_MSG_GCTRL_ALLIANCE_BATTLE_SUBMISSION_REQ_FB:
		{
			...
			case EMALLIANCE_BATTLE_SUBMISSION_FB_CTFMAP:
				CInnerInterface::GetInstance().PrintMsgTextDlg ( NS_UITEXTCOLOR::NEGATIVE, ID2GAMEINTEXT("EMALLIANCE_BATTLE_SUBMISSION_FB_CTFMAP") );
				break;
			}
		}
		break;
