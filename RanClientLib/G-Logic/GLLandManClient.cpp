...
BOOL GLLandManClient::DropOutItem ( DWORD dwGlobID )
{
	...
	//added by :   | 05-03-2012 | added item drop effect
	//DxEffGroupPlayer::GetInstance().DeletePassiveEffect ( GLCONST_CHAR::strMINE_EFFECT.c_str(), sTARID );
