...
protected:
	...
	void NewTarget ( const STARGETID &sTargetID );
...
public:
	void RESET_DATA ();
	HRESULT CreateCrow ( GLMobSchedule *pMobSchedule, GLLandMan* pLandMan, SNATIVEID sCROWID, LPDIRECT3DDEVICEQ pd3dDevice=NULL, LPD3DXVECTOR3 pPos=NULL );
