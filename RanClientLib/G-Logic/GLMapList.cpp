...
HRESULT GLMapList::LoadMapList ( const TCHAR* szMapListFile, LPF_SERVER_INFO pServerInfo, int nServerNum )
{
	...
	for ( DWORD i=0; i<dwNUM; ++i )
	{
		...
		cFILE.getflag( i, "MAP_LIST", "MAP", 21, nMapKeySize, MapNode.bRRZone );
		cFILE.getflag( i, "MAP_LIST", "MAP", 22, nMapKeySize, MapNode.bSWZone );

		bool b;
		cFILE.getflag( i, "MAP_LIST", "MAP", 23, nMapKeySize, b );	
