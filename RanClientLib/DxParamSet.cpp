...
namespace DXPARAMSET
{
	...
	void INIT ()
	{
		...
		GetInstance().m_bCHARACTER_SIMPLIFY = RANPARAM::bCHARACTER_SIMPLIFY;
...
//		GetInstance().m_bDIS_FRIEND = RANPARAM::bDIS_FRIEND;		
	...
	void STESTSET::GameOK(CD3DApplication *pD3dApp)
	{
		...
		RANPARAM::bCHARACTER_SIMPLIFY = m_bCHARACTER_SIMPLIFY;
