...
const char* CItemSuitTree::GetFormatName ( SITEM* pItem )
{
	...
	else
	{
		...
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_FIGHTER_M )	strItem += "BrawlerM | ";
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_FIGHTER_W )	strItem += "BrawlerW | ";
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_ARMS_M )		strItem += "SwordsmanM | ";
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_ARMS_W )		strItem += "SwordsmanW | ";
		...
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_SPIRIT_M )		strItem += "ShamanM | ";
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_SPIRIT_W )		strItem += "ShamanW | ";
		...
		//if ( pItem->sBasicOp.dwReqCharClass&GLCC_EXTREME_W )	strItem += "ExtremeW";
		//add class
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_SCIENCE_M )	strItem += "GunnerM | ";
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_SCIENCE_W )	strItem += "GunnerW | ";
		...
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_TESTING_M )	strItem += "MagicianM | ";
		if ( pItem->sBasicOp.dwReqCharClass&GLCC_TESTING_W )	strItem += "MagicianW ";
