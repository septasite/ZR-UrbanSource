...
void CItemParent::UpdateItems ()
{
	...
	SetWin_Check ( this, IDC_CHECK13, m_pDummyItem->sBasicOp.dwFlags&ITEM_NO_FAIL );;
	...
	SetWin_Check ( this, IDC_CHECK_ASSASIN_M, m_pDummyItem->sBasicOp.dwReqCharClass&GLCC_ASSASSIN_M );
	SetWin_Check ( this, IDC_CHECK_ASSASIN_W, m_pDummyItem->sBasicOp.dwReqCharClass&GLCC_ASSASSIN_W );
	...
	//
	SetWin_Num_int ( this, IDC_EDIT_NEEDLEVELUP2, m_pDummyItem->sBasicOp.nRebornReq );
...
BOOL CItemParent::InverseUpdateItems ()
{
    ...
    SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK13 ), m_pDummyItem->sBasicOp.dwFlags, ITEM_NO_FAIL ) ;

	//add locker
	//SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_LOCKER ), m_pDummyItem->sBasicOp.dwFlags, TRADE_LOCKER );
	//add ownership
	//SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_OWNERSHIP ), m_pDummyItem->sBasicOp.dwFlags, ITEM_OWNERSHIP );
	//add point sell
	//SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_POINTSELL ), m_pDummyItem->sBasicOp.dwFlags, ITEM_POINT_RECOVER );
	//add jitem
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_COMBINE ), m_pDummyItem->sBasicOp.dwFlags, ITEM_COSTUME_COMBINE );
	...
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_ASSASIN_M ), m_pDummyItem->sBasicOp.dwReqCharClass, GLCC_ASSASSIN_M ); 
	SetCheck_Flags ( GetWin_Check ( this, IDC_CHECK_ASSASIN_W ), m_pDummyItem->sBasicOp.dwReqCharClass, GLCC_ASSASSIN_W ); 
	...
	//
	m_pDummyItem->sBasicOp.nRebornReq = GetWin_Num_int ( this, IDC_EDIT_NEEDLEVELUP2 );
...
void CItemParent::OnBnClickedCheck13()
{
