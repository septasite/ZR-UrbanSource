...
#define Exe_Name PROCESSENTRY32 *pe32 = GetProcessInfo (Load.Main_Name) 
#define Threads (pe32->cntThreads)
#define Ativa_DC (Load.Dont_kill_yet)    
#define NumeroMinimo (Load.Minimum_thread) 

void Msg_K_En(){
	MessageBoxA(NULL,"K-Scan\n\nFile Integrity violated!", Load.Window_Name, MB_SERVICE_NOTIFICATION | MB_ICONWARNING);
	}
