...
protected:
	...
	char		m_szRandomString[USR_CAPTCHA+1];
...
public:
	...
	int		ConnectLoginServer(const char *szAddress, UINT nPort=7545);		//login port
	...
	*/
	...
	int	SndChatRegion(const char* szMsg, SITEMLINK* pItemLink ); //add region chat by AnFire16 ( 7/31/2017)
