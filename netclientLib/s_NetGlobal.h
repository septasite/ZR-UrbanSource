...
#define NET_DEFAULT_PORT			6215	//login port

//#define NET_DATA_BUFSIZE			1024    // Data Buffer Size
#define NET_DATA_BUFSIZE			2048	// Data Buffer Size //Fix Clubwars delay skills
...
enum EMNET_MSG_CHAT
{
	...
	CHAT_TYPE_GLOBAL_STAFF2	= (11),
	CHAT_TYPE_REGION		= (12), //add region chat by AnFire16 ( 7/31/2017)
};
...
{
	EM_REGISTER_FB_SUB_OK             =  0, // 로그인 성공
	EM_REGISTER_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_REGISTER_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
	EM_REGISTER_FB_SUB_DUP		      =  3, // 중복된 접속
};

enum EM_PASS_FB_SUB
{
	EM_PASS_FB_SUB_OK             =  0, // 로그인 성공
	EM_PASS_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_PASS_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
};

enum EM_RESETPASS_FB_SUB
{
	EM_RESETPASS_FB_SUB_OK             =  0, // 로그인 성공
	EM_RESETPASS_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_RESETPASS_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
};

enum EM_RESETPIN_FB_SUB
{
	EM_RESETPIN_FB_SUB_OK             =  0, // 로그인 성공
	EM_RESETPIN_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_RESETPIN_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
};

enum EM_PIN_FB_SUB
{
	EM_PIN_FB_SUB_OK             =  0, // 로그인 성공
	EM_PIN_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_PIN_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
	EM_PIN_FB_SUB_DUP		      =  3, // 중복된 접속
};

enum EM_EMAIL_FB_SUB
{
	EM_EMAIL_FB_SUB_OK             =  0, // 로그인 성공
	EM_EMAIL_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_EMAIL_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
	EM_EMAIL_FB_SUB_DUP		      =  3, // 중복된 접속
};

enum EM_RP_FB_SUB
{
	EM_RP_FB_SUB_OK             =  0, // 로그인 성공
	EM_RP_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_RP_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
	EM_RP_FB_SUB_DUP		      =  3, // 중복된 접속
};

enum EM_TOPUP_FB_SUB
{
	EM_TOPUP_FB_SUB_OK             =  0, // 로그인 성공
	EM_TOPUP_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_TOPUP_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
	EM_TOPUP_FB_SUB_DUP		      =  3, // 중복된 접속
};

enum EM_GT2VP_FB_SUB
{
	EM_GT2VP_FB_SUB_OK             =  0, // 로그인 성공
	EM_GT2VP_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_GT2VP_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
	EM_GT2VP_FB_SUB_DUP		      =  3, // 중복된 접속
};

enum EM_PP2VP_FB_SUB
{
	EM_PP2VP_FB_SUB_OK             =  0, // 로그인 성공
	EM_PP2VP_FB_SUB_FAIL			  =  1, // 로그인 실패
	EM_PP2VP_FB_SUB_SYSTEM	      =  2, // 시스템에러로 로그인 실패
	EM_PP2VP_FB_SUB_DUP		      =  3, // 중복된 접속
};
...
//
#if defined(CH_PARAM)
	#define NET_MSG_BASE				1968				  // 기본 메시지
	...
	#define NET_MSG_BASE				989				  // 기본 메시지 //release build
...
//	NET_MSG_PING_ANSWER		    = 151, //< 서버에서 ping 을 응답한다.	
	...
	CHINA_NET_MSG_REGISTER         = (NET_MSG_LOBBY + 161), //< China 로그인
	CHINA_NET_MSG_REGISTER_FB      = (NET_MSG_LOBBY + 162), //< China 로그인 결과 Agent->Client

	CHINA_NET_MSG_EMAIL         = (NET_MSG_LOBBY + 163), //< China 로그인
	CHINA_NET_MSG_EMAIL_FB      = (NET_MSG_LOBBY + 164), //< China 로그인 결과 Agent->Client

	CHINA_NET_MSG_PIN         = (NET_MSG_LOBBY + 165), //< China 로그인
	CHINA_NET_MSG_PIN_FB      = (NET_MSG_LOBBY + 166), //< China 로그인 결과 Agent->Client
	
	CHINA_NET_MSG_TOPUP         = (NET_MSG_LOBBY + 167), //< China 로그인
	CHINA_NET_MSG_TOPUP_FB      = (NET_MSG_LOBBY + 168), //< China 로그인 결과 Agent->Client
	CHINA_NET_MSG_TOPUP_GEN         = (NET_MSG_LOBBY + 169), //< China 로그인
	CHINA_NET_MSG_TOPUP_GEN_FB      = (NET_MSG_LOBBY + 170), //< China 로그인 결과 Agent->Client
	CHINA_NET_MSG_GT2VP         = (NET_MSG_LOBBY + 171), //< China 로그인
	CHINA_NET_MSG_GT2VP_FB      = (NET_MSG_LOBBY + 172), //< China 로그인 결과 Agent->Client
	
	CHINA_NET_MSG_PASS         = (NET_MSG_LOBBY + 173), //< China 로그인
	CHINA_NET_MSG_PASS_FB      = (NET_MSG_LOBBY + 174), //< China 로그인 결과 Agent->Client

	CHINA_NET_MSG_RESETPASS         = (NET_MSG_LOBBY + 175), //< China 로그인
	CHINA_NET_MSG_RESETPASS_FB      = (NET_MSG_LOBBY + 176), //< China 로그인 결과 Agent->Client

	CHINA_NET_MSG_RESETPASS2         = (NET_MSG_LOBBY + 177), //< China 로그인
	CHINA_NET_MSG_RESETPASS2_FB      = (NET_MSG_LOBBY + 178), //< China 로그인 결과 Agent->Client
	
	CHINA_NET_MSG_RESETPIN         = (NET_MSG_LOBBY + 179), //< China 로그인
	CHINA_NET_MSG_RESETPIN_FB      = (NET_MSG_LOBBY + 180), //< China 로그인 결과 Agent->Client

	CHINA_NET_MSG_PP2VP         = (NET_MSG_LOBBY + 181), //< China 로그인
	CHINA_NET_MSG_PP2VP_FB      = (NET_MSG_LOBBY + 182), //< China 로그인 결과 Agent->Client
	...
	NET_MSG_LOBBY_USER_SEL		= (NET_MSG_LOBBY + 389), //< 필드서버->클라이언트 : 캐릭터 선택용 정보.
...
//-----------------------------------------------------------------------------------------------------------
	...
	NET_MSG_GCTRL_REQ_HOLD_ARRAY		= (NET_MSG_GCTRL + 1088),	// 스타일변경
	NET_MSG_GCTRL_REQ_HOLDARRAY_TO_INVEN	= (NET_MSG_GCTRL + 1089),	// 스타일변경
	...
	NET_MSG_GCTRL_ONWARD_BRD						= (NET_MSG_GCTRL + 1596),	//<	클럽데스매치 상황 요청
	NET_MSG_GCTRL_CANNOT_POT						= (NET_MSG_GCTRL + 1597),	//add antipot
	NET_MSG_GCTRL_UPDATE_CP							= (NET_MSG_GCTRL + 1598),	//add cp
	NET_MSG_GCTRL_QITEMFACT_TIMEUPDATE_BRD			= (NET_MSG_GCTRL + 1599),	//add qbox

	NET_MSG_GCTRL_INVEN_GMITEM						= (NET_MSG_GCTRL + 1600),	//add itemcmd
	NET_MSG_GCTRL_INVEN_GMITEM_FB					= (NET_MSG_GCTRL + 1601),	//add itemcmd


	//NET_MSG_GCTRL_REQ_ALLOW_BET						= (NET_MSG_GCTRL + 1602),	//add duel bet
	//NET_MSG_GCTRL_REQ_ALLOW_BET_FB					= (NET_MSG_GCTRL + 1603),	//add duel bet

	//NET_MSG_GCTRL_UPDATE_DUELWIN					= (NET_MSG_GCTRL + 1604), //add duel bet
	//NET_MSG_GCTRL_UPDATE_DUELLOSS					= (NET_MSG_GCTRL + 1605), //add duel bet

	NET_MSG_GCTRL_INVEN_BIKECOLOR_CHANGE			= (NET_MSG_GCTRL + 1602),	//add bike color
	NET_MSG_GCTRL_INVEN_BIKECOLOR_CHANGE_FB			= (NET_MSG_GCTRL + 1603),	//add bike color
	NET_MSG_GCTRL_INVEN_BIKECOLOR_CHANGE_BRD		= (NET_MSG_GCTRL + 1604),	//add bike color

	//add pk
	NET_MSG_GCTRL_UPDATE_PKWIN						= (NET_MSG_GCTRL + 1605),
	NET_MSG_GCTRL_UPDATE_PKLOSS						= (NET_MSG_GCTRL + 1606),
	NET_MSG_GCTRL_UPDATE_PKWIN_BRD					= (NET_MSG_GCTRL + 1607),
	NET_MSG_GCTRL_UPDATE_PKLOSS_BRD					= (NET_MSG_GCTRL + 1608),

	NET_MSG_GCTRL_UPDATE_PKSTREAK					= (NET_MSG_GCTRL + 1609),	//add pk streak by njd
	NET_MSG_GCTRL_UPDATE_PKSTREAK_BRD				= (NET_MSG_GCTRL + 1610),	//add pk streak by njd

	NET_MSG_GCTRL_REQ_STATSUPCMD					= (NET_MSG_GCTRL + 1611),	//<	STATS UP
	NET_MSG_GCTRL_REQ_STATSUPCMD_FB					= (NET_MSG_GCTRL + 1612),	//<	STATS UP 응답
	
	NET_MSG_GCTRL_SCHOOL_WARS_REMAIN_BRD	= (NET_MSG_GCTRL + 1616),
	NET_MSG_GCTRL_SCHOOL_WARS_READY_FLD		= (NET_MSG_GCTRL + 1617),
	NET_MSG_GCTRL_SCHOOL_WARS_START_FLD		= (NET_MSG_GCTRL + 1618),
	NET_MSG_GCTRL_SCHOOL_WARS_START_BRD		= (NET_MSG_GCTRL + 1619),

	NET_MSG_GCTRL_SCHOOL_WARS_END_FLD		= (NET_MSG_GCTRL + 1620),
	NET_MSG_GCTRL_SCHOOL_WARS_END_BRD		= (NET_MSG_GCTRL + 1621),

	NET_MSG_GCTRL_SERVER_SCHOOL_WARS_INFO	= (NET_MSG_GCTRL + 1622),
	NET_MSG_GCTRL_REQ_SERVER_SCHOOL_WARS_REMAIN_AG	= (NET_MSG_GCTRL + 1623),	

	NET_MSG_GCTRL_SCHOOL_WARS_POINT_UPDATE		= (NET_MSG_GCTRL + 1624),
	NET_MSG_GCTRL_SCHOOL_WARS_MYRANK_UPDATE		= (NET_MSG_GCTRL + 1625),
	NET_MSG_GCTRL_SCHOOL_WARS_RANKING_UPDATE	= (NET_MSG_GCTRL + 1626),
	NET_MSG_GCTRL_SCHOOL_WARS_RANKING_REQ		= (NET_MSG_GCTRL + 1627),

	NET_MSG_GCTRL_SCHOOL_WARS_PPOINT_UPDATE			= (NET_MSG_GCTRL + 1628),
	NET_MSG_GCTRL_SCHOOL_WARS_MYPRANK_UPDATE		= (NET_MSG_GCTRL + 1629),
	NET_MSG_GCTRL_SCHOOL_WARS_PRANKING_UPDATE		= (NET_MSG_GCTRL + 1630),
	NET_MSG_GCTRL_SCHOOL_WARS_PRANKING_REQ			= (NET_MSG_GCTRL + 1631),

	//add sw buff
	NET_MSG_GM_SCHOOL_EVENT							= (NET_MSG_GCTRL + 1632),

	NET_MSG_GCTRL_SCHOOL_WARS_CERTIFIED_AGT	= (NET_MSG_GCTRL + 1633),	
	NET_MSG_GCTRL_SCHOOL_WARS_CERTIFIED_FLD	= (NET_MSG_GCTRL + 1634),	

	NET_MSG_GCTRL_SCHOOL_WARS_SETWINSCHOOL_BRD		= (NET_MSG_GCTRL + 1635),
	//Add Royal Rumble - JADev
	NET_MSG_GCTRL_ROYAL_RUMBLE_REMAIN_BRD		= (NET_MSG_GCTRL + 1654),
	NET_MSG_GCTRL_ROYAL_RUMBLE_READY_FLD		= (NET_MSG_GCTRL + 1655),
	NET_MSG_GCTRL_ROYAL_RUMBLE_START_FLD		= (NET_MSG_GCTRL + 1656),
	NET_MSG_GCTRL_ROYAL_RUMBLE_START_BRD		= (NET_MSG_GCTRL + 1657),

	NET_MSG_GCTRL_ROYAL_RUMBLE_END_FLD		= (NET_MSG_GCTRL + 1658),
	NET_MSG_GCTRL_ROYAL_RUMBLE_END_BRD		= (NET_MSG_GCTRL + 1659),

	NET_MSG_GCTRL_SERVER_ROYAL_RUMBLE_INFO		= (NET_MSG_GCTRL + 1660),
	NET_MSG_GCTRL_REQ_SERVER_ROYAL_RUMBLE_REMAIN_AG	= (NET_MSG_GCTRL + 1661),	

	NET_MSG_GCTRL_ROYAL_RUMBLE_PPOINT_UPDATE	= (NET_MSG_GCTRL + 1662),
	NET_MSG_GCTRL_ROYAL_RUMBLE_MYPRANK_UPDATE	= (NET_MSG_GCTRL + 1663),
	NET_MSG_GCTRL_ROYAL_RUMBLE_PRANKING_UPDATE	= (NET_MSG_GCTRL + 1664),
	NET_MSG_GCTRL_ROYAL_RUMBLE_PRANKING_REQ		= (NET_MSG_GCTRL + 1665),
	//End Royal Rumble - JADev

	NET_MSG_GCTRL_SCHOOL_WAR_REMAIN_BRD				= (NET_MSG_GCTRL + 1636),	//<	클럽데스매치 남은시간.
	NET_MSG_GCTRL_SCHOOL_WAR_READY_FLD				= (NET_MSG_GCTRL + 1637),	//<	클럽데스매치 준비.
	NET_MSG_GCTRL_SCHOOL_WAR_START_FLD				= (NET_MSG_GCTRL + 1638),	//<	클럽데스매치 시작.
	NET_MSG_GCTRL_SCHOOL_WAR_START_BRD				= (NET_MSG_GCTRL + 1639),	//<	클럽데스매치 시작.

	NET_MSG_GCTRL_SCHOOL_WAR_END_FLD				= (NET_MSG_GCTRL + 1640),	//<	클럽데스매치 종료.
	NET_MSG_GCTRL_SCHOOL_WAR_END_BRD				= (NET_MSG_GCTRL + 1641),	//<	클럽데스매치 종료.

	NET_MSG_GCTRL_SERVER_SCHOOL_WAR_INFO			= (NET_MSG_GCTRL + 1642),	//<	클럽데스매치 정보 전송 ( 접속시 ) 
	NET_MSG_GCTRL_REQ_SERVER_SCHOOL_WAR_REMAIN_AG	= (NET_MSG_GCTRL + 1643),	//<	클럽데스매치 정보 전송 ( Agent에 남은시간 요청 )

	NET_MSG_GCTRL_SCHOOL_WAR_POINT_UPDATE			= (NET_MSG_GCTRL + 1644),	//<	클럽데스매치 Kill/Death 상황 ( 자기만 )
	NET_MSG_GCTRL_SCHOOL_WAR_MYRANK_UPDATE			= (NET_MSG_GCTRL + 1645),	//<	클럽데스매치 Kill/Death 상황 ( 자기만 )
	NET_MSG_GCTRL_SCHOOL_WAR_RANKING_UPDATE			= (NET_MSG_GCTRL + 1646),	//<	클럽데스매치 랭킹 상황
	NET_MSG_GCTRL_SCHOOL_WAR_RANKING_REQ			= (NET_MSG_GCTRL + 1647),	//<	클럽데스매치 상황 요청

	NET_MSG_REBUILD_SEALED_CARD						= (NET_MSG_GCTRL + 1863),	//Sealed Card by NaJDev - Added by Ocram Networkso
	NET_MSG_REBUILD_OPTION							= (NET_MSG_GCTRL + 1864),	//Sealed Card by NaJDev - Added by Ocram Networkso

	NET_MSG_GCTRL_VIEW_PROPERTIES				= (NET_MSG_GCTRL + 1648),//add charinfoview
	NET_MSG_GCTRL_VIEW_PROPERTIES_FB			= (NET_MSG_GCTRL + 1649),//add charinfoview
	NET_MSG_GCTRL_VIEW_PROPERTIES_TAR			= (NET_MSG_GCTRL + 1650),//add charinfoview
	
	NET_MSG_GCTRL_VIEWCHAROTEM					= (NET_MSG_GCTRL + 1651),
	NET_MSG_GCTRL_VIEWCHAROTEM_TAR				= (NET_MSG_GCTRL + 1652),
	NET_MSG_GCTRL_VIEWCHAROTEM_SLOT_TAR			= (NET_MSG_GCTRL + 1653),
	NET_MSG_GCTRL_REQ_ALLOW_VIEW_CHARINFO		= (NET_MSG_GCTRL + 1654),	//add duel bet
	NET_MSG_GCTRL_REQ_ALLOW_VIEW_CHARINFO_FB	= (NET_MSG_GCTRL + 1655),	//add duel bet
	...
	NET_MSG_REBUILD_MOVE_SEAL 	= (NET_MSG_GCTRL + 1674), //sealed card NaJDeV
//Request Crow List NaJDeV
	NET_MSG_REQ_CROWLIST		= (NET_MSG_GCTRL + 1675),
	NET_MSG_REQ_CROWLIST_FB		= (NET_MSG_GCTRL + 1676),
	NET_MSG_GCTRL_REQ_DISABLESKILLEFF				= (NET_MSG_GCTRL + 1677), 
	NET_MSG_GCTRL_REQ_DISABLESKILLEFF_BRD			= (NET_MSG_GCTRL + 1678),
	NET_MSG_GCTRL_REQ_DISABLESKILLEFF_FB			= (NET_MSG_GCTRL + 1679),
	NET_MSG_REQ_CROWLIST_FLD	= (NET_MSG_GCTRL + 1680),

	NET_MSG_GCTRL_GLOBAL_SUCCESS_GRIND = (NET_MSG_GCTRL + 1681),
	NET_MSG_GCTRL_GLOBAL_SUCCESS_GRIND_FB = (NET_MSG_GCTRL + 1682),
	
	NET_MSG_GM_SLOT_EVENT			  = (NET_MSG_GCTRL + 1683),	//slot event
	NET_MSG_GM_SLOT_EVENT_FLD			  = (NET_MSG_GCTRL + 1684),	//slot event
	NET_MSG_GM_SLOT_EVENT_BRD			  = (NET_MSG_GCTRL + 1685),	//slot event

	NET_MSG_GCTRL_UPDATE_MONEYTYPE					= (NET_MSG_GCTRL + 1868),
	//dmk14
	NET_MSG_GCTRL_TOWERWARS_START_ENTRY					= (NET_MSG_GCTRL + 1918),
	...
	NET_MSG_GCTRL_TOWERWARS_CTF_EXIT_MAP				= (NET_MSG_GCTRL + 1930),

	//link skill
	NET_MSG_GCTRL_REQ_LINKSKILLEFF						= (NET_MSG_GCTRL + 1945),
	NET_MSG_GCTRL_REQ_LINKSKILLEFF_FB					= (NET_MSG_GCTRL + 1946),
	NET_MSG_GCTRL_REQ_LINKSKILLEFF_BRD					= (NET_MSG_GCTRL + 1947),
	NET_MSG_GCTRL_REQ_LINKSKILLEFF_CROW_BRD				= (NET_MSG_GCTRL + 1948),

	//dmk14 | 11-21-16 | dual pet skill
	NET_MSG_PET_DUAL_SKILL								= (NET_MSG_GCTRL + 1949),
	NET_MSG_PET_DUAL_SKILL_FB							= (NET_MSG_GCTRL + 1950),

	//dmk14 | 12-9-16 | item compound
	NET_MSG_GCTRL_INVEN_ITEM_COMPOUND					= (NET_MSG_GCTRL + 1951),
	NET_MSG_CTF										= (NET_MSG_GCTRL + 2013),
	NET_MSG_CTF_BRD									= (NET_MSG_GCTRL + 2014),
	NET_MSG_CTF_WIN									= (NET_MSG_GCTRL + 2015),
	NET_MSG_GCTRL_SERVER_WINNER						= (NET_MSG_GCTRL + 2016),
	...
	NET_MSG_GCTRL_REQ_CTF_ACQUIRED					= (NET_MSG_GCTRL + 2021),
	NET_MSG_GCTRL_REQ_CTF_ACQUIRED_BRD				= (NET_MSG_GCTRL + 2022),
	NET_MSG_TYRANNY_PARTICIPATE				= (NET_MSG_GCTRL + 2043),
	NET_MSG_TYRANNY_PARTICIPATE_BRD					= (NET_MSG_GCTRL + 2045),
	NET_MSG_GCTRL_REQ_TYRANNY_GETREWARD				= (NET_MSG_GCTRL + 2046),
	NET_MSG_GCTRL_REQ_TYRANNY_GETREWARD_FB			= (NET_MSG_GCTRL + 2047),
	NET_MSG_INVEN_WRAP								= (NET_MSG_GCTRL + 2056), // wrapper
	NET_MSG_INVEN_REMOVE_WRAP						= (NET_MSG_GCTRL + 2057), // wrapper
	NET_MSG_AP_DT			                 	= (NET_MSG_GCTRL + 2063), // Global AP Detecct 
	NET_MSG_AP_DT_FB			             	= (NET_MSG_GCTRL + 2064), // Announcement bes.
	NET_MSG_AP_DT_BRD			             	= (NET_MSG_GCTRL + 2065), // Para Mahiya onte.
//	NET_MSG_GCTRL_INVEN_GRINDING_BRD			= (NET_MSG_GCTRL + 2066), // global grind - Eduj 
	NET_MSG_WPE_DT_BRD		                	= (NET_MSG_GCTRL + 2067), // global grind - Eduj 
	NET_MSG_PVP_REJOIN		                    = (NET_MSG_GCTRL + 2068), //BattleFieldUI Data Rejoin - Eduj
	NET_MSG_PVP_REJOIN_BRD		                = (NET_MSG_GCTRL + 2069), //BattleFieldUI Data Rejoin - Eduj
	NET_MSG_INVEN_NONDROP						= (NET_MSG_GCTRL + 2075), //nondrop card Eduj
	NET_MSG_INVEN_NONDROP_BRD					= (NET_MSG_GCTRL + 2076), //nondrop card Eduj
	NET_MSG_INVEN_REMOVE_NONDROP						= (NET_MSG_GCTRL + 2077), //nondrop card Eduj
	NET_MSG_INVEN_REMOVE_NONDROP_BRD					= (NET_MSG_GCTRL + 2078), //nondrop card Eduj

	NET_MSG_GCTRL_TOWERWARS_WINNER_FLD			= (NET_MSG_GCTRL + 2070),
	NET_MSG_GCTRL_TOWERWARS_WINNER_BRD			= (NET_MSG_GCTRL + 2071),
	NET_MSG_GCTRL_REQ_TO_AGENT_TOWERWARS_WINNER = (NET_MSG_GCTRL + 2072),
	NET_MSG_GCTRL_CROW_CHECK_TARGET				= (NET_MSG_GCTRL + 2073),
	NET_MSG_GCTRL_REQ_TARGET_ACQUIRE			= (NET_MSG_GCTRL + 2074),
	NET_MSG_GCTRL_INVEN_SCHOOL_CHANGE			= (NET_MSG_GCTRL + 2079),	//Added by DUTERTE
	NET_MSG_GCTRL_INVEN_SCHOOL_CHANGE_FB		= (NET_MSG_GCTRL + 2080),	//Added by DUTERTE
	NET_MSG_GCTRL_INVEN_SCHOOL_CHANGE_BRD		= (NET_MSG_GCTRL + 2081),	//Added by DUTERTE
	NET_MSG_GCTRL_TOWERWARS_WINNER_REQ	        = (NET_MSG_GCTRL + 2082), // Eduj Dev
	NET_MSG_GCTRL_TOWERWARS_SERVER_WINNER	    = (NET_MSG_GCTRL + 2083), // Eduj Dev
	NET_MSG_GCTRL_TOWERWARS_WINNER_PLAYER_UPDATE	    = (NET_MSG_GCTRL + 2084), // Eduj Dev

	NET_MSG_GCTRL_GET_ITEMSHOP_FROMDB	= (NET_MSG_GCTRL + 2085),//<	구입한 아이템 정보 DB에서 가져오기 요청
	NET_MSG_GCTRL_GET_ITEMSHOP_FROMDB_FB = (NET_MSG_GCTRL + 2086),//<	구입한 아이템 정보 DB에서 가져오기 요청 FB
	NET_MSG_GCTRL_BUY_ITEMSHOP = (NET_MSG_GCTRL + 2087),//<	구입한 아이템 정보 DB에서 가져오기 요청
	NET_MSG_GCTRL_BUY_ITEMSHOP_FB = (NET_MSG_GCTRL + 2088),//<	구입한 아이템 정보 DB에서 가져오기 요청 FB
	NET_MSG_GCTRL_BUY_ITEMSHOP_ITEM	= (NET_MSG_GCTRL + 2089),	//<	구입한 아이템 인벤에 넣기 요청.
	NET_MSG_GCTRL_ADD_ITEMSHOP_ITEM	= (NET_MSG_GCTRL + 2090),	//<	구입한 아이템 인벤에 넣기 요청.
	NET_MSG_GCTRL_ADD_ITEMSHOP_ITEM_FB	= (NET_MSG_GCTRL + 2091),	//<	구입한 아이템 인벤에 넣기 요청.
...
struct NET_RANDOMPASS_NUMBER
{
	NET_MSG_GENERIC nmg;
	INT nRandomNumber;
	TCHAR	szRandomString[USR_CAPTCHA+2];

	NET_RANDOMPASS_NUMBER()
	{
		nmg.dwSize = sizeof(NET_RANDOMPASS_NUMBER);
		nmg.nType  = NET_MSG_RANDOM_NUM;
		SecureZeroMemory(szRandomString,         sizeof(CHAR) * (USR_CAPTCHA+2));
		nRandomNumber = 0;
	}
};
